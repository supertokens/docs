...
const siteConfig = {
  ...
  baseUrl: "/docs/auth0/", // when creating new documentation, replace auth0 with folder name
  ...
  */
  ...
  // NOTE: when adding a new documentation, change auth0 with the folder name
  scripts: [
    "https://buttons.github.io/buttons.js",
    'https://cdnjs.cloudflare.com/ajax/libs/clipboard.js/2.0.0/clipboard.min.js',
    "/docs/auth0/scripts/builder.js",
  ],
