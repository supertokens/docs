...
const siteConfig = {
  title: "SuperTokens Android", // Title for your website.
  tagline: "A website for testing",
  url: "https://supertokens.io", // Your website URL
  baseUrl: "/docs/android/", // when creating new documentation, replace initialDocs with folder name
  ...
  */
  ...
  scripts: [
    ...
    "/docs/android/scripts/builder.js",
  ],
