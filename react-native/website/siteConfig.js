...
const siteConfig = {
  ...
  baseUrl: "/docs/react-native/", // when creating new documentation, replace react-native with folder name
  ...
  */
  ...
  // NOTE: when adding a new documentation, change react-native with the folder name
  scripts: [
    "https://buttons.github.io/buttons.js",
    'https://cdnjs.cloudflare.com/ajax/libs/clipboard.js/2.0.0/clipboard.min.js',
    "/docs/react-native/scripts/builder.js",
  ],
