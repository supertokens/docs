			...
			<div className="admonition admonition-caution alert alert--warning">
				...
				<div className="admonition-content">
					...
					<p>
						...
						please check the{" "}
						<a href="/docs/authentication/unified-login/customizations/verify-tokens">
							separate page
						</a>{" "}
			...
			<div className="admonition admonition-caution alert alert--warning">
				...
				<div className="admonition-content">
					...
					<p>
						...
						you will have to manually check the <code>email_verified</code>{" "}
						claim on the <strong>OAuth2 Access Tokens</strong>. Please read the{" "}
						<a href="/docs/authentication/unified-login/customizations/verify-tokens">
							separate page
						</a>{" "}
			...
			<div className="theme-admonition theme-admonition-caution alert alert--warning">
				...
				<div className="admonition-content">
					...
					<p>
						...
						explore the{" "}
						<a href="/docs/authentication/unified-login/unified-login/introduction">
