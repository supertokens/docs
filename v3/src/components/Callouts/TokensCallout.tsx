...
export function TokensCallout({ children }: React.PropsWithChildren<{}>): JSX.Element {
  return (
    <SideModal.Root defaultOpen={false}>
      <Flex direction="column" gap="4" asChild>
        <Callout.Root color="orange" variant="surface" size="2" className="admonition">
            ...
            <Flex flexGrow="1" gap="2" align="center" direction="row">
              ...
              <SideModal.Content className="http-request-card-details-modal" size="s">
                <Flex direction="column" flexGrow="1">
                  ...
                  <Text mt="2">
                    These tokens adhere to the OAuth2 specifications. They are used in the <b>Client Credentials</b>{" "}
                    (M2M) and in the <b>Authorization Code</b> (Unified Login) flows to authenticate clients and access
                    protected resources.
                  </Text>
                </Flex>
          ...
          {children ? <div className="admonition__content">{children}</div> : null}
        </Callout.Root>
      </Flex>
    </SideModal.Root>
  );
