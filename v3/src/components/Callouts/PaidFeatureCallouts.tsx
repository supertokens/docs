      ...
      <div className="admonition admonition-caution alert alert--warning">
        ...
        <div className="admonition-content">
          <p>
            ...
            to get a license key and follow the instructions sent to you by email. Using the dev license key is free. We
      ...
      <div className="admonition admonition-caution alert alert--warning">
        ...
        <div className="admonition-content">
          <p>
            ...
            to get a license key and follow the instructions sent to you by email. Creation of tenants is free on the
            dev license key.
          </p>
          <p>
            This feature is already enabled for managed service users. Creation of additional tenant is free on the
