...
type FrontendMobileTabsProps = Omit<TabsProps, "values" | "groupId">;

const FrontendMobileSubTabsGroupId = "frontend-mobile-sub-tabs";

export function FrontendMobileSubTabs({
  children,
  ...rest
}: FrontendMobileTabsProps) {
  return (
    <FrontendTabsContext.Provider value={{ values: MobileSubTabsItems }}>
      <Tabs
        values={MobileSubTabsItems}
        groupId={FrontendMobileSubTabsGroupId}
        {...rest}
      >
        {children}
      </Tabs>
