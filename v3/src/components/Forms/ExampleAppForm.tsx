...
import { Grid, Text, Box, Heading, Flex, Card, TextField, VisuallyHidden, Separator } from "@radix-ui/themes";
    ...
    <Card style={{ padding: "0" }} mb="4">
      <Form.Root asChild>
        <Flex gap="2" direction="column" px="4" pt="5" pb="0">
          ...
          <Text color="gray">
            Update the form based on your tech stack and requirements. Once you're done, copy the command and run it in
            your terminal.
          </Text>
          <Grid
            columns={{
          ...
          >
            <Form.Field name="frontendFramework" asChild>
              <Flex gap="1" direction="column">
                ...
                <Form.Control asChild>
                  <Select.Root value={frontendFramework} onValueChange={setFrontendFramework}>
                    <Select.Trigger />
                    <Select.Content>
