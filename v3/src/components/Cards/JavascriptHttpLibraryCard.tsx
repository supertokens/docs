import {
	...
	useJavascriptHttpLibrarySelection,
} from "../Select/JavascriptHttpLibrarySelect";

import { CodeSampleCard } from "./CodeSampleCard";

import "./styles.scss";

function JavascriptHttpLibraryCardRoot({
	children,
...
export const JavascriptHttpLibraryCard = Object.assign(
