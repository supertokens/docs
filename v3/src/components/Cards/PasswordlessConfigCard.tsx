import { PasswordlessFlowTypeSelect, PasswordlessContactMethodSelect } from "../Select";
...
export const PasswordlessConfigCard = Object.assign(PasswordlessConfigCardRoot, {
