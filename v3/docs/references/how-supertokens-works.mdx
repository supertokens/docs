...
Each login method is a separate recipe. So if you want email password login, you should see the [emailpassword recipe docs](/docs/authentication/email-password/introduction), for passwordless, you should see the [passwordless recipe docs](/docs/authentication/passwordless/introduction).
