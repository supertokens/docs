...
let appInfo: {
    appName: string,
    websiteDomain: string,  // For Python SDK, this is client_domain
    apiDomain: string,
    websiteBasePath?: string,  // For Python SDK, this is client_base_path
    apiBasePath?: string,  
...
:::note
For Python SDK, this parameter is called `client_domain`
:::
...
:::note
For Python SDK, this parameter is called `client_base_path`
:::
