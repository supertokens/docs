...
sidebar_position: 2
description: >-
  Enable debug logs for backend and frontend in SuperTokens for effective
  troubleshooting.
---

import { SelfHostingTabs, BackendTabs, FrontendPrebuiltUITabs, FrontendCustomUITabs } from "/src/components/Tabs";
