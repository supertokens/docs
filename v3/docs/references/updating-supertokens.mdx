...
You will need to shut down your core in order to update it. After it's off, run the migration scripts for all versions in-between
...
- ### Managed core
If you're using the managed core service, please email us at support@supertokens.com from your registered email to request a core update.
