...
sidebar_position: 5
description: >-
  Add and read custom request properties using SuperTokens SDK's pre API hook,
  overrides, and user context.
---
...
You can use our [pre-API hook feature](/docs/references/sdks/frontend-hooks/pre-api) to add custom information to network requests made by the frontend SDKs.
