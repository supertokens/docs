...
sidebar_position: 1
description: >-
  Override the default auth behavior with custom UI, frontend, backend
  functions, APIs, and hooks.
---
...
- Providing a custom router for routing that happens within our pre-built UI. For example, integrating the Next.js router.
