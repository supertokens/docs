...
sidebar_position: 1
description: >-
  Customize email delivery methods, including default, SMTP, and full control
  options.
---
...
- Password reset
- Email verification ([if enabled](/docs/additional-verification/email-verification/enable-email-verification))
...
Learn more about this method in the [SMTP section](/docs/platform-configuration/email-delivery/smtp-service/configure-smtp).
