...
sidebar_position: 2
description: >-
  Send emails using the default service without configuration via SuperTokens'
  backend SDK.
---
...
- Default [email verification template](/docs/references/user-interface/ui-showcase/email-verification) and its [source code](https://github.com/supertokens/email-sms-templates/blob/master/email-html/email-verification.html).
- Default [password reset template](/docs/references/user-interface/ui-showcase/password-reset) and its [source code](https://github.com/supertokens/email-sms-templates/blob/master/email-html/password-reset.html).
