...
Once you have [created tenants](./new-tenant) for your app with specific login methods enabled for them (third party, email password, passwordless), you have to pick which **authentication recipe** to use in your app.
...
- If you have enabled email password login for all tenants, you can use the [email password recipe](https://supertokens.com/docs/authentication/email-password/introduction).
- If you have enabled third party login for all tenants, you can use the [third party recipe](https://supertokens.com/docs/authentication/social/introduction).
