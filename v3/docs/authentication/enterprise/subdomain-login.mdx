...
An example app for this setup with our **pre-built UI** can be found on [our GitHub example directory](https://github.com/supertokens/supertokens-auth-react/tree/master/examples/with-one-login-per-subdomain). The app is setup to have three tenants:
...
After you have shown the login methods and the user tries to sign in, you have to follow all the steps for mobile app login are similar to the [social login steps](../../custom-ui/thirdparty-login), except that when you are calling the sign in up API, you also need to pass in the tenantId in the request path. An example of this is shown below:
