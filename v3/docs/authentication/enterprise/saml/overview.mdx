...
Your `SAML` identity provider provides a metadata file (which is a .xml file) that you or your end users need to upload to the `SAML` client.
...
The HTTP service is written in NodeJS, and is embeddable within your NodeJS backend.
