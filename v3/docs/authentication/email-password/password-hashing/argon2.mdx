...
sidebar_position: 1
description: >-
  Optimize Argon2 hashing settings for secure password storage by calibrating to
  your hardware.
---
...
This is the number of threads the algorithm uses during hashing. The higher this is, the harder it would be to crack passwords offline using multiple cores.
