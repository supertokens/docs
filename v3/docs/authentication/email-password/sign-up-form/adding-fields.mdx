...
sidebar_position: 1
description: >-
  Add custom fields to sign-up forms and handle them in backend with
  SuperTokens.
---
...
Call the following API when the user clicks on the sign up button (the command below can be tried on your terminal).
...
You might want to get more information from your customers on sign up.
