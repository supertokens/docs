...
Explore the references pages for a more in depth guide on [hooks](/docs/references/sdks/frontend-hooks/handle-event) and [overrides](/docs/references/sdks/functions-overrides/about).
