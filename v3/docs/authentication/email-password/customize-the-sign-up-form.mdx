...
:::caution
**SuperTokens** does not store custom form fields. You can either save them in your database or use the [User Metadata feature ](/docs/post-authentication/user-management/user-metadata/about).
:::
