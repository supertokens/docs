...
The following page provides a high level overview of how **OAuth2** works.
Each quickstart guide makes use of these concepts so you should understand them before trying to implement the guides.
