...
Each quickstart guide uses OAuth2 specific concepts that you should understand.
Read through this page in order to get a better understanding of the spcifications. 
