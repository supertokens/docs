...
sidebar_position: 3
description: >-
  Implement web authentication for desktop and mobile apps using OAuth2
---
...
## User accesses the native application
 - The user gets redirected to [**Authorization Service**](/docs/authentication/unified-login/introduction#authorization-server) authentication URL.
 - The [**Authorization Service**](/docs/authentication/unified-login/introduction#authorization-server) redirects the user to the login UI
...
## The application uses the callback URL information to request a **OAuth2 Access Token** from the [**Authorization Service**](/docs/authentication/unified-login/introduction#authorization-server).
...
- [Single Backend Setup](/docs/authentication/unified-login/quickstart-guides/multiple-frontends-with-a-single-backend#3-set-up-your-authorization-service-backend)
