...
sidebar_position: 2
description: >-
  Set up multiple frontend domains with separate backends using
...
You can use the following guide if you have a single [**Authorization Service**](/docs/authentication/unified-login/introduction#authorization-server) that multiple applications use.
...
For each of your applications you need to create a separate [**OAuth2 client**](/docs/authentication/unified-login/introduction#client).
...
In your [**Authorization Service**](/docs/authentication/unified-login/introduction#authorization-server) you need to initialize the **OAuth2Provider** recipe.
The recipe exposes the endpoints needed for enabling the [**OAuth 2.0**](/docs/authentication/unified-login/introduction#oauth-20) flow.
...
After the user has logged in from the [**Authorization Service**](/docs/authentication/unified-login/introduction#authorization-server) they redirect to the `backend` callback URL.
