...
1. The User accesses the `frontend` app
   - The application `frontend` redirects the user to [**Authorization Service**](/docs/authentication/unified-login/introduction#authorization-service) authorize URL.
...
2. The User completes the login attempt 
   - The [**Authorization Service**](/docs/authentication/unified-login/introduction#authorization-service) backend redirects the user to the `callback URL`.
3. The User accesses the callback URL
   - The `frontend` uses the callback URL information to obtain a **OAuth2 Access Token** from the [**Authorization Service**](/docs/authentication/unified-login/introduction#authorization-service).
