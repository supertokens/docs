...
You can use the following guide if you have a single [**Authorization Service**](/docs/authentication/unified-login/introduction#authorization-server) that is used by multiple applications.
...
1. The User accesses the `frontend` app
   ...
   - The `backend` application generates an `authorization` URL to the [**Authorization Service**](/docs/authentication/unified-login/introduction#authorization-server) and redirects the user to it.
...
2. The User completes the login attempt 
   - The [**Authorization Service**](/docs/authentication/unified-login/introduction#authorization-server) backend redirects the user to a `callback URL` that includes the **Authorization Code**.
...
After the user has logged in from the [**Authorization Service**](/docs/authentication/unified-login/introduction#authorization-server) they will be redirected to the `backend` callback URL.
