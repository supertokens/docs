...
:::info Important
Remember to [initialise the user metadata recipe](/docs/post-authentication/user-management/user-metadata/setup) on the backend `recipeList` during `supertokens.init`.
:::
