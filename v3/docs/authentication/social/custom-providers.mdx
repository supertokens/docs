...
<ReferenceCard.Grid>
  <ReferenceCard href="/docs/post-authentication/user-management/common-actions/get-user-info" label="Get user info from the third party provider" />
  <ReferenceCard href="/docs/multi-tenancy/introduction" label="Multi-tenancy Single Sign-On (SSO)" />
