...
The following sections describe how you can modify adjust the `thirdparty` recipe to your needs.
...
Overriding the `signInUp` function will allow you to introduce your own logic for the sign in process.
