...
sidebar_position: 5
description: >-
  Customize the authentication flow to trigger events like analytics or
  database updates.
---
...
<ReferenceCard.Grid>
  <ReferenceCard href="/docs/references/sdks/functions-overrides/about" label="Functions overrides" />
  <ReferenceCard href="/docs/references/sdks/apis-overrides/about" label="APIs overrides" />
  <ReferenceCard href="/docs/references/sdks/frontend-hooks/handle-event" label="Frontend hooks" />
  <ReferenceCard href="/docs/references/user-interface/react-component-override/about" label="React component override" />
