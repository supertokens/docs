...
For each of your **`microservices`** you need to create a separate [**OAuth2 client**](/docs/authentication/unified-login/introduction#client).
...
In your [**Authorization Server**](/docs/authentication/unified-login/introduction#authorization-server) backend, initialize the **OAuth2Provider** recipe.
...
You can directly call the [**Authorization Server**](/docs/authentication/unified-login/introduction#authorization-server) to generate Access Tokens.
