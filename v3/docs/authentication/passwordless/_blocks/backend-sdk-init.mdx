...
The init call includes [configuration details](/docs/references/app-info) for your app. It specifies how the backend connects to the **SuperTokens Core**, as well as the **Recipes** used in your setup.
