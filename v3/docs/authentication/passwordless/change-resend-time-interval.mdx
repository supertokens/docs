...
This limit is only enforced on the client-side. For API rate-limiting please check out the [References section](/docs/references/sdks/apis-overrides/api-override).
