...
<ReferenceCard.Grid>
  ...
  <ReferenceCard href="/docs/authentication/passwordless/customize-the-magic-link">
    ...
    <ReferenceCard.Description>
      Change how Magic Links are created.
    </ReferenceCard.Description>
  </ReferenceCard>
  ...
  <ReferenceCard href="/docs/platform-configuration/email-delivery/about">
    ...
    <ReferenceCard.Description>
      Customize how emails are delivered to your users.
    </ReferenceCard.Description>
  </ReferenceCard>
  <ReferenceCard href="/docs/platform-configuration/sms-delivery/about">
    ...
    <ReferenceCard.Description>
      Customize how Short Message Service (SMS) messages are delivered to your users.
    </ReferenceCard.Description>
  </ReferenceCard>
</ReferenceCard.Grid>
