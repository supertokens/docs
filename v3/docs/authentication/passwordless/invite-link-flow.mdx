...
This guide assumes that you have already implemented the [EmailPassword recipe](/docs/guides/emailpassword) and have a working application integrated with **SuperTokens**.
