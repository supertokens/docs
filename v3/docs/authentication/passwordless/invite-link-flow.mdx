---
title: Implement an invite link based sign up
hide_title: true
...
- You can change the lifetime of the magic link, and therefore the invite link, by following [this guide](/docs/authentication/passwordless/otp-magic-link-expiration).
