...
The following sections describe how you can modify adjust the `passwordless` recipe to your needs.
...
Overriding the `consumeCode` function will allow you to introduce your own logic for the authentication process.
