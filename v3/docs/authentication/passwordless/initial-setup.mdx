...
The invocation includes the [main configuration details](/docs/references/app-info), as well as the **recipes** that you use in your setup.
...
<ReferenceCard.Grid>
  ...
  <ReferenceCard href="/docs/platform-configuration/sms-delivery/about">
    ...
    <ReferenceCard.Description>
      Customize how SMS messages are delivered to your users.
    </ReferenceCard.Description>
  </ReferenceCard>
</ReferenceCard.Grid>
