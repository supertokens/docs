...
import { CodeSampleCard, NodeFrameworksCard, GoFrameworksCard, PythonFrameworksCard } from "/src/components/Cards";
...
Please check [our guide](/docs/references/other-frameworks) that shows you how to resolve this.
...
The init call will include [configuration details](/docs/references/app-info) for your app, how the backend will connect to the **SuperTokens Core**, as well as the **Recipes** that will be used in your setup.
