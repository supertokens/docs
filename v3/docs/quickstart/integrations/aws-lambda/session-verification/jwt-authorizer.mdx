...
If you implementing an **OAuth2** setup, through the [**Unified Login**](/docs/unified-login/introduction) or the [**Microservice Authentication**](/docs/microservice_auth/client-credentials) features, you will have to manually set the token audience property. 
