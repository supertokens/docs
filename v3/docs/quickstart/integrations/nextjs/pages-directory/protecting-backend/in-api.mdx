...
- In case the session does exist, `req.session` can be used to get session information. Learn more about this object [here](/docs/additional-verification/session-verification/protect-api-routes/verify-session#the-session-object).
