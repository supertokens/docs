...
description: >-
  Learn how to use SuperTokens with Hasura
---
...
Refer to [this page](/docs/additional-verification/session-verification/protect-api-routes/manual-jwt-verification#method-2-using-public-key-string) to know how to get a public key as a string, you can then use that key string in the Hasura config:
