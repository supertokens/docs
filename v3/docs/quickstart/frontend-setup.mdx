...
import { FrontendTabs, ReactRouterVersionTabs, NodePackageManagerTabs } from "/src/components/Tabs";
...
<FrontendTabs>
  <FrontendTabs.Tab value="reactjs">
    <NodePackageManagerTabs>
      <NodePackageManagerTabs.Tab value="npm7+">

```bash
npm i -s supertokens-auth-react
```

  </NodePackageManagerTabs.Tab>

<NodePackageManagerTabs.Tab value="npm6">
...
<NodePackageManagerTabs.Tab value="yarn">
