...
import { NodeFrameworksCard, PythonFrameworksCard } from "/src/components/Cards";
...
This guide will show you how to achieve this by only allowing a certain type of users, `admins`, to perform the impersonation.

## Before you start

:::caution
Since this feature allows you to login as any user in your application, it should be protected to only allow admins or custom support staff to use it.
