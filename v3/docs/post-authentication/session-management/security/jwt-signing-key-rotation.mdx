...
sidebar_position: 1
description: >-
  Rotate access token signing keys to enhance security and configure key
  rotation intervals.
---
...
If you do not want to use dynamic keys for session creation, then you can tell SuperTokens to use the static key instead. This is useful in cases where you want to [hardcode the public key for JWT verification in some process](/docs/additional-verification/session-verification/protect-api-routes/manual-jwt-verification#method-2-using-public-key-string).
