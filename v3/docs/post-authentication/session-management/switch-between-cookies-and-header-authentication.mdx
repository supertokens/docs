...
The following guide will show you how to switch between them.
...
This choice is ultimately controlled by the backend, but it follows a preference set in the frontend configuration.
