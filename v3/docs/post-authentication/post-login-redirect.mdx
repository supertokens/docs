...
:::info
Please refer to [this page](/docs/references/sdks/frontend-hooks/redirection-callback) to learn more about the `getRedirectionURL` hook.
:::
...
<ReferenceCard.Grid>
  ...
  <ReferenceCard href="/docs/references/sdks/frontend-hooks/redirection-callback" label="Redirection Callback Hook" />
