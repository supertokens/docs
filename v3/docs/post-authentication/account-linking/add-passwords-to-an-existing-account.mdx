...
First, you need to detect if there already exists a password for the user. You can do this by inspecting the [user object](/docs/references/user-object) on the backend and checking if there is an `emailpassword` login method.
