...
Then, if no such login method exists, you will have to show a UI in which the user can add a password to their account. The default password validation rules can be found [here](/docs/authentication/email-password/sign-up-form/field-validators#changing-the-default-email-and-password-validators).
