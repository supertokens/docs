...
sidebar_position: 6
description: >-
  Change default SuperTokens user IDs to custom values for user migration or
  preferred formats.
---
...
This feature allows you to change the default SuperTokens user ID (UUID v4) to a value that you prefer. The two primary use cases for this are:
- Use case 1: During [migration of users](/docs/migration/account-migration)
...
This topic is better covered [under the migration section](/docs/migration/account-migration). The main purpose of this is that you can retain the existing user IDs of your users when migrating them to SuperTokens. This makes it easier to migrate users without having to update the user IDs in your database.
