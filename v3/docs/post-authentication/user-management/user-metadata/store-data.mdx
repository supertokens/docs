...
:::info Multi Tenancy
User metadata that is associated with a user is shared across all tenants that that user is a part of. If instead, you want to store usermetadata on a tenant level, you can add a custom key in the JSON like:
