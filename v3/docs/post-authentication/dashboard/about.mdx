...
sidebar_position: 1
description: >-
  Manage users, sessions, and roles using the SuperTokens user management
  dashboard.
---
...
Before you can use the user management dashboard make sure to complete setting up SuperTokens on your backend by following the [quickstart guide](/docs/quickstart/introduction).
...
<img src="/img/dashboard/signup.png" alt="Dashboard signup screen UI" />
