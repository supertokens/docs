...
sidebar_position: 4
description: >-
  Manage user roles and permissions using the user management dashboard in your
  app.
---
...
You can manage [user roles and permissions](/docs/additional-verification/user-roles/introduction) of your app from the user management dashboard.
...
Please note that the capability to manage roles and permissions from the user management dashboard is available only from Node SDK version `v16.6.0` or later.
