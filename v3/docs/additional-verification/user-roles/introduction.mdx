...
hide_title: true
description: >-
  Manage user roles and permissions with SuperTokens.
---
...
With it, you can create roles and perissions, assign them to your users and limit access based on your application.
