...
hide_title: true
description: >-
  Protect API and frontend routes using SuperTokens session access tokens and
...
If you are implementing [**Unified Login**](/docs/authentication/unified-login/introduction), that uses **OAuth2 Access Tokens**, please check our [separate page](/docs/authentication/unified-login/customizations/verify-tokens) that shows you how to validate them.
