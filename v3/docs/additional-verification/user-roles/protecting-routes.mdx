...
If you are implementing [**Unified Login**](/docs/authentication/unified-login/introduction), that uses **OAuth2 Access Tokens**, please check our [separate page](/docs/authentication/unified-login/verify-tokens) that shows you how to validate them.
