...
hide_title: true
description: >-
  Manage roles and permissions by adding, removing, and listing permissions for
  user roles.
---
...
You can also add, remove and edit permissions for a role from the user management dashboard. To know more about how to manage your user roles and permissions from user management dashboard see [this page](/docs/post-authentication/dashboard/managing-user-roles-and-permissions)
