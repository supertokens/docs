...
| **Data Sensitivity**                 | Secure—data is not exposed to the frontend | Data is included in the access token, which is accessible to the frontend |
...
class Session:
    ...
    async def revoke_session(self, user_context=None):
        pass

    # Retrieves the session data stored in the database associated with the session.
    # Optional user_context can be used for additional contextual data.
    async def get_session_data_from_database(self, user_context=None):
        pass

    # Sets a new JSON object to the session data stored in the database.
    # `new_session_data` is the new session data to store.
    # Optional user_context can be used for additional contextual data.
    async def update_session_data_in_database(self, new_session_data, user_context=None):
        pass

    # Returns the user ID of the logged-in user.
    # Optional user_context can be used for additional contextual data.
    def get_user_id(self, user_context=None):
        pass
    ...
    # Optional user_context can be used for additional contextual data.
    def get_recipe_user_id(self, user_context=None):
        pass
    ...
    # Default value is "public" if multi-tenancy is not used.
    # Optional user_context can be used for additional contextual data.
    def get_tenant_id(self, user_context=None):
        pass
    ...
    # Includes user-defined claims, standard claims, and SuperTokens specific ones.
    # Optional user_context can be used for additional contextual data.
    def get_access_token_payload(self, user_context=None):
        pass
    ...
    # a unique string constant for each session.
    # Optional user_context can be used for additional contextual data.
    def get_handle(self, user_context=None):
        pass
    ...
    # Returns the raw string access token for this session.
    # Optional user_context can be used for additional contextual data.
    def get_access_token(self, user_context=None):
        pass
    ...
    # Optional user_context can be used for additional contextual data.
    async def merge_into_access_token_payload(self, access_token_payload_update, user_context=None):
        pass


    # Returns the time in milliseconds of when this session was created.
    # Optional user_context can be used for additional contextual data.
    async def get_time_created(self, user_context=None):
        pass


    # Returns the time in milliseconds of when this session will expire if not refreshed.
    # Optional user_context can be used for additional contextual data.
    async def get_expiry(self, user_context=None):
        pass
    ...
    # Optional user_context can be used for additional contextual data.
    async def assert_claims(self, claim_validators, user_context=None):
        pass
    ...
    # Optional user_context can be used for additional contextual data.
    async def fetch_and_set_claim(self, claim, user_context=None):
        pass
    ...
    # Optional user_context can be used for additional contextual data.
    async def set_claim_value(self, claim, value, user_context=None):
        pass
    ...
    async def get_claim_value(self, claim, user_context=None):
        pass
    ...
    # Optional user_context can be used for additional contextual data.
    async def remove_claim(self, claim, user_context=None):
        pass
    ...
    # Optional user_context can be used for additional contextual data.
    async def attach_to_request_response(self, req_res_info, user_context=None):
        pass
