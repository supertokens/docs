...
To use the anomaly detection service, send requests to the appropriate regional endpoint based on your location:
...
<HTTPRequestCard path="/v1/security" method="post" title="Anomaly Detection">
