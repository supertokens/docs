...
The following page will show you how to include the **Attack Protection Suite** feature in your **SuperTokens** integration.
...
:::info Important
This step is required only for bot detection and anomaly IP based detection such as impossible travel detection.
...
To retrieve the request ID in the backend you have to override the recipe implemenations.
