...
Most of the updates are required if you are using the **pre-built UI** components.
If you are working with a **custom UI** you just need to update the backend configuration, like in step **3.1**.
