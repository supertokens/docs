...
With the **Email Verification** recipe, you can make sure that the email address of a user is confirmed before they can use your application.
The functionality needs be enabled explicitly through the configuration steps.
