...
You need to start by choosing your first factor auth. This can be any of the [auth recipes](https://supertokens.com/docs/guides) we support. A common choice is to combine teh thirdparty and emailpassword recipes, which allows users to sign in with social or email / password login.
