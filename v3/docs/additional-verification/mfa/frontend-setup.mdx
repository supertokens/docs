...
sidebar_position: 4
description: >-
  Configure frontend multi-factor authentication with Supertokens for single and
...
### 3. Step: Checking the `next` array
...
### 4. Step: Checking for factor setup
