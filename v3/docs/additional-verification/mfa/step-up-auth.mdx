...
import { MobileFrameworksCard, NpmOrScriptsCard, NodeFrameworksCard, PythonSyncAsyncCard } from "/src/components/Cards";
import {
...
<PythonSyncAsyncCard>
<PythonSyncAsyncCard.Content value="fastapi">
...
<PythonSyncAsyncCard.Content value="flask">
...
<PythonSyncAsyncCard.Content value="django">
