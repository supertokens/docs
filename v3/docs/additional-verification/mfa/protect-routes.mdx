...
<NodeFrameworksCard>
<MobileFrameworksCard.Content value="express">
...
<MobileFrameworksCard.Content value="hapi">
...
<MobileFrameworksCard.Content value="fastify">
...
<MobileFrameworksCard.Content value="awsLambda">
...
<MobileFrameworksCard.Content value="koa">
...
<MobileFrameworksCard.Content value="loopback">
...
<MobileFrameworksCard.Content value="nextjs">
...
<MobileFrameworksCard.Content value="nextjs-app">
...
<MobileFrameworksCard.Content value="nestjs">
...
<FrontendPrebuiltUITabs.TabItem value="web">
