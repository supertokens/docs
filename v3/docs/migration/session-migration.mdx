...
You can follow our [guide](/docs/additional-verification/session-verification/protect-api-routes/manual-jwt-verification#method-2-using-public-key-string) on how to do this.
:::

### Call the migration endpoint from your frontend app
