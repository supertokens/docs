...
sidebar_position: 1
description: >-
  Migrate users from external authentication to SuperTokens, covering accounts,
  data, and sessions.
---
...
If you are using MFA in your app, checkout the MFA migration section [here](/docs/additional-verification/mfa/migration) after you have gone through the above migration steps.
