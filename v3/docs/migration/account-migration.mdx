...
### 1. Update the legacy sing up flow 
...
If your application has a sign up process please make sure that you have completed the [**first step**](#1-update-the-legacy-sing-up-flow).
