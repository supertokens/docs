...
sidebar_position: 3
description: >-
  Migrate user metadata, roles, and permissions to SuperTokens using API
  requests.
---
...
:::info Important
Roles and permissions must be created before they can be assigned to a user. You can follow this [guide](/docs/additional-verification/user-roles/creating-role) on creating roles and permissions in SuperTokens.
:::
