...
const siteConfig = {
  title: "SuperTokens NodeJS", // Title for your website.
  tagline: "A website for testing",
  url: "https://supertokens.io", // Your website URL
  baseUrl: "/docs/nodejs/", // when creating new documentation, replace initialDocs with folder name
  ...
  */
  ...
  scripts: [
    ...
    "/docs/nodejs/scripts/builder.js",
  ],
