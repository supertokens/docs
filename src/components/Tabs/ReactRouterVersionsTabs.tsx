...
function ReactRouterVersionTabsRoot(props: ReactRouterVersionTabsProps) {
  ...
  return (
    <Tabs values={ReactRouterVersionTabItems} groupId={ReactRouterVersionTabsGroupId} {...rest}>
      {children}
    </Tabs>
  );
}

export const ReactRouterVersionTabs = Object.assign(ReactRouterVersionTabsRoot, {
  Tab: TabItem,
  TabItem,
});
