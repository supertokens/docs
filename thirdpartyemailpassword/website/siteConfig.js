...
const siteConfig = {
  ...
  baseUrl: "/docs/thirdpartyemailpassword/", // when creating new documentation, replace thirdpartyemailpassword with folder name
  // Used for publishing and more, irrelevant for us
  projectName: "test-site",
  organizationName: "facebook",
  // For no header links in the top nav bar -> headerLinks: [],
  headerLinks: [
    { doc: "introduction", label: "Docs" }, // main is the id for the default document
  ...
  */
  ...
  // NOTE: when adding a new documentation, change thirdpartyemailpassword with the folder name
  scripts: [
    "https://buttons.github.io/buttons.js",
    'https://cdnjs.cloudflare.com/ajax/libs/clipboard.js/2.0.0/clipboard.min.js',
    "/docs/thirdpartyemailpassword/scripts/builder.js",
  ],
