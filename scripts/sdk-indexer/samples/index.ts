...
export default class SuperTokensWrapper {
  ...
  static getUserCount(includeRecipeIds?: string[], tenantId?: string, userContext?: Record<string, any>) {
    return SuperTokens.getInstanceOrThrowError().getUserCount(includeRecipeIds, tenantId, getUserContext(userContext));
  }
  ...
  static async deleteUser(userId: string, removeAllLinkedAccounts: boolean = true, userContext?: Record<string, any>) {
