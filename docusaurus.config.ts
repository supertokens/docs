...
const config: Config = {
  ...
  themeConfig: {
    ...
    metadata: [
      {
        name: "keywords",
        content: "authentication, open source, login, authorization, security, session management",
      },
      { name: "robots", content: "index, follow" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:creator", content: "@supertokens.io" },
      { name: "twitter:title", content: "SuperTokens, Open Source User Authentication" },
      {
        name: "twitter:description",
        content: "Open Source User Authentication. Build fast, maintain control, with reasonable pricing.",
      },
      { name: "twitter:image", content: "https://supertokens.com/assets/images/website/og/homepage.png" },
      { property: "og:image", content: "https://supertokens.com/assets/images/website/og/homepage.png" },
  ...
  headTags: [
    {
      ...
      innerHTML: JSON.stringify({
        ...
        publisher: {
          ...
          logo: {
            "@type": "ImageObject",
            url: "https://supertokens.com/assets/images/website/og/homepage.png",
          },
        },
      }),
    },
