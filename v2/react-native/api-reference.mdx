...
## `init({apiDomain, apiBasePath?, sessionExpiredStatusCode?, autoAddCredentials?, cookieDomain?, override?, onHandleEvent?, preAPIHook?})`
### Parameters
#### `apiDomain`
- Type: `string`
...
- Type: `boolean`
- Default `true`
- Setting this to true adds `credentials: "include"` to all requests.
