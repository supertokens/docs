...
With the user management dashboard you can view the list users and their details. You can also perform different operations on these users as mentioned below.
