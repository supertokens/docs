...
- Session claim validation [for APIs](../common-customizations/sessions/session-validators) and [the frontend](../common-customizations/sessions/session-validators)
