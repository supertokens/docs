...
:::tip
You can easily add, remove and edit permissions for a role from the user management dashboard. To know more about how to manage your user roles and permissions from user management dashboard look <a href="/docs/userdashboard/managing-user-roles-and-permissions" target="_blank">here</a>
:::
