...
func main() {
	...
	userInfo, err := thirdpartypasswordless.GetUsersByEmail("test@example.com", nil)
	if err != nil {
		// TODO: Handle error
		return
	}
...
```python
from supertokens_python.recipe.thirdpartypasswordless.asyncio import get_user_by_email
...
func main() {
	...
	userInfo, err := thirdpartypasswordless.GetUserByPhoneNumber("+1234567890", nil)
	if err != nil {
		// TODO: Handle error
		return
	}
...
func getUserInfoAPI(w http.ResponseWriter, r *http.Request) {
	...
	// highlight-next-line
	userInfo, err := thirdpartypasswordless.GetUserByID(userID, nil)
	if err != nil {
		// TODO: Handle error
		return
	}
