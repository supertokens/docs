...
If you are using our SuperTokens managed service, we will host the Boxy HQ server for you ([reach out to us](mailto:team@supertokens.com) to activate your instance).
