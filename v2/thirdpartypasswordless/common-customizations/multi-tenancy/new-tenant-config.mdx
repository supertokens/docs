...
Once you have created a tenant with third party enabled, you need to configure which third party providers to enable for the tenant. We have several [in built providers](../signup-form/provider-config), but you can also configure [a custom provider](./custom-provider).
...
- You can see the required information for other providers [on this page](../signup-form/provider-config).
