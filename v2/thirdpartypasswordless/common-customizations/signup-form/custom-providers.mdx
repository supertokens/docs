...
from supertokens_python import init, InputAppInfo
from supertokens_python.recipe import ^{codeImportRecipeName}
from supertokens_python.recipe.thirdparty.provider import Provider, ProviderConfigForClient
...
class CustomProvider(Provider):
    ...
    async def get_profile_info(self, auth_code_response: Dict[str, Any], user_context: Dict[str, Any]) -> UserInfo:
        ...
        return UserInfo(third_party_user_id="...", email=UserInfoEmail(email="..", email_verified=True))
