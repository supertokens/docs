...
- Changing the OTP / magic link [resend interval](TODO) or [lifetime](TODO)
- [Changing number of retries for OTP](TODO)
- [Changing OTP format](TODO)
- [Adding a terms of services and privacy policy link](TODO)
- Changing [the content of](TODO) or how [emails and / or SMS are sent](TODO)
- [Generating OTPs and magic links without user action](TODO)
- [Chaning email or phone number validation logic](TODO)