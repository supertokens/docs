...
<img src="/img/^{codeImportRecipeName}-enter-otp-error.png" alt="Enter OTP screen general error" />
...
- [Changing the default country for phone number inputs](TODO)
- [Changing the OTP / magic link resend interval](TODO)
- [Changing number of retries for OTP](TODO)
- [Changing lifetime of OTP / Magic link](TODO)
- [Changing OTP format](TODO)
- [Adding a terms of services and privacy policy link](TODO)
- [Changing how emails and / or SMS are sent](TODO)
- [Changing the content of the emails and / or SMS](TODO)
- [Generating OTPs and magic links without user action](TODO)