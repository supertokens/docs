...
- `GET ^{form_apiBasePath}/passwordless/email/exists`: To check if an email is already signed up
- `GET ^{form_apiBasePath}/passwordless/phonenumber/exists`: To check if a phonenumber is already signed up
