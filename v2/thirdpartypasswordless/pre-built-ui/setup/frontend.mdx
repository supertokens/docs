...
- After initializing `supertokens-auth-react`, we can use either the `supertokens-auth-react` or `supertokens-web-js` in the application, since the former also initializes the latter.
