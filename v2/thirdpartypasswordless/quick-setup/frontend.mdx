...
- We've wrapped the entire application with `SuperTokensWrapper`. This is optional but provides session information in all of your components. Check [here](../common-customizations/get-user-info#on-the-frontend) to see how you can access it.
:::
