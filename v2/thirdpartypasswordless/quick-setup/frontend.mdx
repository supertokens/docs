...
- Your Angular app will load the react component whenever we visit an `auth` related route.
- The react component will render the login UI and handle authentication.
