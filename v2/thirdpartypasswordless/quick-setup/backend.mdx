...
An example implementation can be [found here](https://github.com/supertokens/supertokens-auth-react/blob/master/examples/with-thirdpartypasswordless/api-server/index.js).
...
## 4) Initialise Social login providers
...
## 5) Add the SuperTokens APIs & CORS setup
...
## 7) Test if sign up is setup correctly
