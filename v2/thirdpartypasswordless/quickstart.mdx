...
To implement your own custom UI you can follow our [separate guide](./custom-ui/init/frontend).
...
supertokens.init({
    ...
    recipeList: [
        ...
        ThirdParty.init(/*TODO: See next steps for third party provider setup */),
