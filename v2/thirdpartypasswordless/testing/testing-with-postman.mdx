...
You can find more information about header-based sessions [here](../common-customizations/sessions/token-transfer-method).
:::
...
<img alt="Successful creation of code using postman" width="600px" src="/img/passwordless/sp-test-signup-1.png" />
...
<img alt="Successful signup request using the generated code in postman" width="600px" src="/img/passwordless/sp-test-signup-2.png" />

You can see the session tokens set by the response by clicking on the Cookies button on the top right

<img alt="Viewing session tokens set by the response in postman" width="600px" src="/img/passwordless/st-test-signin-cookies.png" />
