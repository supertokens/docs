...
import (
	...
	"github.com/supertokens/supertokens-golang/recipe/^{codeImportRecipeName}"/plessmodels"
...
func main() {
	...
	supertokens.Init(supertokens.TypeInput{
		RecipeList: []supertokens.Recipe{
			^{codeImportRecipeName}".Init(plessmodels.TypeInput{
...
```python
from supertokens_python.recipe.^{codeImportRecipeName}" import CreateAndSendCustomTextMessageParameters
...
```python
from supertokens_python.recipe.^{codeImportRecipeName}" import CreateAndSendCustomEmailParameters
from typing import Union, Dict, Any
...
```python
from supertokens_python.recipe.^{codeImportRecipeName}" import CreateAndSendCustomEmailParameters, CreateAndSendCustomTextMessageParameters
from typing import Union, Dict, Any
