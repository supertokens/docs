...
def override_passwordless_apis(original_implementation: APIInterface):
    ...
    async def consume_code_post(pre_auth_session_id: str, user_input_code: Union[str, None], device_id: Union[str, None], link_code: Union[str, None], tenant_id: str, api_options: APIOptions,
