	...
	thirdpartypasswordless.Init(&tpplessmodels.TypeInput{
		...
		Override: &tpplessmodels.OverrideStruct{
			APIs: func(originalImplementation tpplessmodels.APIInterface) tpplessmodels.APIInterface {
				...
				(*originalImplementation.passwordlessUserEmailExistsGET) = func(email string, options plessmodels.APIOptions, userContext supertokens.UserContext) (plessmodels.EmailExistsGETResponse, error) {
