...
from supertokens_python.recipe.thirdpartypasswordless.interfaces import RecipeInterface, ConsumeCodeOkResult, ThirdPartySignInUpOkResult
...
def override_thirdpartypasswordless_functions(original_implementation: RecipeInterface):
    ...
    async def thirdparty_sign_in_up(third_party_id: str, third_party_user_id: str, email: str,
        ...
        if isinstance(response, ThirdPartySignInUpOkResult):
