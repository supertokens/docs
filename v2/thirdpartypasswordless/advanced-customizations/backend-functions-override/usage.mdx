...
:::info
See all the [functions that can be overrided here](https://pkg.go.dev/github.com/supertokens/supertokens-golang@v0.0.6/recipe/thirdpartypasswordless/tpplessmodels#RecipeInterface)
:::
...
from supertokens_python.recipe.thirdpartypasswordless.interfaces import ConsumeCodeResult
