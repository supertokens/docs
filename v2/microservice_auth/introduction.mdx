...
:::note
This approach allows you to build a zero trust environment (TODO: remove zero trust) between your microservices in a way that even if they are all open to the internet, they will only be queryable by each other. 
:::
