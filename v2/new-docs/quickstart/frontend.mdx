...
You can view the login UI by visiting <ContextValue property="appInfo.websiteBasePath" />. You can also see all designs of our pre built UI, for each page on [this link](https://master--6571be2867f75556541fde98.chromatic.com/?path=/story/auth-page--playground).
