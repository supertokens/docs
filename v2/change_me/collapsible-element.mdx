...
<details><summary>Collapsible Summary</summary>
Collapsible Element's content that can only be seen when it is expanded. Collapsible Element's content that can only be seen when it is expanded. Collapsible Element's content that can only be seen when it is expanded.
</details>
<details><summary>Collapsible Summary 2nd</summary>
Collapsible Element's content that can only be seen when it is expanded. Collapsible Element's content that can only be seen when it is expanded. Collapsible Element's content that can only be seen when it is expanded.
</details>
