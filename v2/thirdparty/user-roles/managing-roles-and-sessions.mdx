...
After you create a role and assign it to as user, the role and permission information is automatically added to their session. You can then use this information to read and verify the role and permissions in your API and website routes

## Disable automatically adding roles

You can disable adding role information into the access token payload when initializing the recipe:
