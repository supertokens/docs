...
- Google:
    ...
    - Set the authorisation callback URL to `^{form_websiteDomain}^{path_websiteBasePath}/callback/google`
- Github:
    ...
    - Set the authorisation callback URL to `^{form_websiteDomain}^{path_websiteBasePath}/callback/github`
- Facebook:
    ...
    - Set the authorisation callback URL to `^{form_websiteDomain}^{path_websiteBasePath}/callback/facebook`
- Apple:
    ...
    - Set the authorisation callback URL to `^{form_apiDomain}^{path_apiBasePath}/callback/apple`. Note that Apple doesn't allow `localhost` in the URL. So if you are in dev mode, you can use the dev keys we have provided above.
