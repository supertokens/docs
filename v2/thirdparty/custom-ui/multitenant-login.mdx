...
import MultitenancyIntro from '../multitenancy/intro.mdx'
import CreateConfigureTenants from '../multitenancy/create-configure-tenants.mdx'
import BackendCORS from '../multitenancy/backend-cors.mdx'
