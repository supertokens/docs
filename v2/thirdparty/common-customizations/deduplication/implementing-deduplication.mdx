	...
	thirdparty.Init(&tpmodels.TypeInput{
		Override: &tpmodels.OverrideStruct{
			Functions: func(originalImplementation tpmodels.RecipeInterface) tpmodels.RecipeInterface {
				...
				(*originalImplementation.SignInUp) = func(thirdPartyID, thirdPartyUserID, email string, tenantId string, userContext supertokens.UserContext) (tpmodels.SignInUpResponse, error) {
					existingUsers, err := thirdparty.GetUsersByEmail(email, tenantId)
					if err != nil {
...
def override_thirdparty_functions(original_implementation: RecipeInterface):
    ...
    async def sign_in_up(third_party_id: str, third_party_user_id: str, email: str, tenant_id: str,
