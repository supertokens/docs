...
<BackendSDKTabs enableCurl enableDashboard isSubTab={true}>
...
<img src="/img/dashboard/tenant-management/create-provider/create-bitbucket.gif" alt="Create Bitbucket Provider"/>
