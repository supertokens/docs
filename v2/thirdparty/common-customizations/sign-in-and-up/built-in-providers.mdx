...
Refer [this page](../../custom-ui/thirdparty-login) for frontend implementation.
					...
					Providers: []tpmodels.ProviderInput{
						...
						},
						{
							Config: tpmodels.ProviderConfig{
								...
								Clients: []tpmodels.ProviderClientConfig{
									{
										ClientID:         "TODO: AD_CLIENT_ID",
										ClientSecret:     "TODO: AD_CLIENT_SECRET",
										AdditionalConfig: map[string]interface{}{
											"directoryId": "TODO: AD_DIRECTORY_ID",
										},
									},
								},
							},
