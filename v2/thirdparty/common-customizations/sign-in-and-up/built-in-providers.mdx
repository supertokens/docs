...
TODO Fix the config structure and add the missing config
...
- [Get the user profile from the third party provider](../getting-provider-user-profile)
- Multi-tenancy setup
