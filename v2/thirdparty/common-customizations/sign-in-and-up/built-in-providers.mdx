...
:::info
If you would like to change OAuth scopes or add additional parameters to the authorisation redirect URL, you can check the third party configs [here](/docs/nodejs/thirdparty/providers/google)
:::
