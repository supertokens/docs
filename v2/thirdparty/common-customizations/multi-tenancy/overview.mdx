...
Each tenant will have its own user pool. This means that one user can login using the same email across different tenants and they will be treated as different users. You can also share a user across tenants.
