---
id: about
title: How it works (flow diagram)
hide_title: true
---
...
- Minimises impact of XSS attacks (by using `httpOnly` cookies for cookie-based sessions)
...
You can find one of the solutions [here](../../advanced-customizations/examples/localstorage/about).

You can find more information about header-based sessions [here](./token-transfer-method).
:::
