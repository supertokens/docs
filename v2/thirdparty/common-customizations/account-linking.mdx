...
:::info
- An example app that has this feature implemented can be found on [our github](https://github.com/supertokens/supertokens-auth-react/tree/master/examples/with-account-linking).
