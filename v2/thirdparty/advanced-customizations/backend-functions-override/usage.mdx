...
:::info
See all the [functions that can be overrided here](https://supertokens.io/docs/nodejs/interfaces/recipe_thirdparty.RecipeInterface.html)
:::
...
:::info
See all the [functions that can be overrided here](https://supertokens.io/docs/python/recipe/thirdparty/interfaces.html#supertokens_python.recipe.thirdparty.interfaces.RecipeInterface)
:::

```python

# highlight-start
def override_thirdparty_functions(original_implementation):
