...
from supertokens_python import init, InputAppInfo
from supertokens_python.recipe import thirdparty
from supertokens_python.recipe.session.interfaces import RecipeInterface, SessionClaimValidator, SessionClaim, CreateNewSessionResult
...
def override_session_functions(original_implementation: RecipeInterface):
    ...
    async def create_new_session(user_id: str,
        ...
        if user_context["isSignUp"] is True:
            ...
            # (see above code).
            return CreateNewSessionResult(EmptySession(original_implementation))
