...
from supertokens_python import init, InputAppInfo
from supertokens_python.recipe import thirdparty
from supertokens_python.recipe.thirdparty.interfaces import APIInterface, SignInUpPostResponse, APIOptions, SignInUpPostFieldErrorResponse, SignInUpPostNoEmailGivenByProviderResponse, SignInUpPostOkResponse
from supertokens_python.recipe.thirdparty.provider import Provider
...
def override_thirdparty_apis(original_implementation: APIInterface):
    async def sign_in_up_post(provider: Provider, code: str, redirect_uri: str, client_id: Union[str, None], auth_code_response: Union[Dict[str, Any], None], api_options: APIOptions,
        ...
        user_info: UserInfo
        try:
            user_info = await provider.get_profile_info(access_token_response, user_context) # type: ignore
        except Exception as e:
