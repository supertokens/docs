                ...
                apis: (originalImplementation) => {
                    return {
                        ...
                        signInUpPOST: async (input) => {
                            ...
                            let accessTokenPayloadPromise = options.config.sessionFeature.setAccessTokenPayload(
                                response.user,
                            ...
                            await Session.createNewSession(options.res, response.user.id, accessTokenPayload, sessionData);
                            return {
                                status: "OK",
