...
Now in the override config instead of calling the original implementation like we did in [Method 1](#method-1-use-the-override-config) we can paste the signInUpPost code we copied earlier.
                ...
                apis: (originalImplementation) => {
                    return {
                        ...
                        signInUpPOST: async (input) => {
                            ...
                            let response = await signInUpPost(input);
