...
If you want to change it you will need to set the `clientCredentialsGrantAccessTokenLifespan` property in the [**Client**](/docs/unified-login/introduction#client) creation request body.
...
To see a detailed example of how to do this please check our [separate guide](/docs/unified-login/customizations/verify-tokens).
