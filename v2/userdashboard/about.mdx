...
For example, you can resolve the aforementioned error by incorporating the blocked URI domain into your CSP configuration under the violated directive, which, in this case, is `img-src`. Learn more [here](https://content-security-policy.com/)
```text
script-src:
  'self' 
  'unsafe-inline' 
