...
<img src="/img/integration-lambda/sidebar.png" alt="AWS Lamda sidebar UI" height="300" />
...
<BackendSDKTabs disableGolang>
  <TabItem value="nodejs">
    <img src="/img/integration-lambda/node-lambda-layer.png" alt="Lamda layer node configuration UI"/>
  </TabItem>
  <TabItem value="python">
    <img src="/img/integration-lambda/python-lambda-layer.png" alt="Lamda layer python configuration UI"/>
  </TabItem>
</BackendSDKTabs>
