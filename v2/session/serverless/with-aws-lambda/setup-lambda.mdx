...
<BackendSDKTabs disableGolang>
  <TabItem value="nodejs">
    <img src="/img/integration-lambda/create-function-node.png"/>
  </TabItem>
  <TabItem value="python">
    <img src="/img/integration-lambda/create-function-python.png"/>
  </TabItem>
</BackendSDKTabs>
...
<img src="/img/integration-lambda/add-a-layer.png" width="700"/>

- Select `Custom Layer` and then select the layer we created in the first step:

<BackendSDKTabs disableGolang>
  <TabItem value="nodejs">
    <img src="/img/integration-lambda/add-layer-detail-node.png"/>
...
## 4) Add SuperTokens auth middlewares
...
<img src="/img/integration-lambda/add-auth-middleware-node.png"/>
...
<img src="/img/integration-lambda/add-env-var-node.png"/>
:::
