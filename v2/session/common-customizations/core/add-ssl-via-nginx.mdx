...
:::important
- This guide assumes you have already installed NGINX on your Ubuntu server.
- For the example given below we will be running the SuperToknes core on domain `localhost` and port `3567`
- The Open API spec for the Core APIs can be found [here](https://app.swaggerhub.com/apis/supertokens/CDI).
:::
...
- We can start by editing the default NGINX site config by running the following command in terminal:
