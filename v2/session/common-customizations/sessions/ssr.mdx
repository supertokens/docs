...
:::important
Getting access to the session during server side rendering is only possible using cookie-based sessions. This is the default settings, but you have to keep this in mind if you want to switch to header-based sessions.
:::
