...
The `verifySession` middleware can only be used in scenarios that involve **SuperTokens Access Tokens**.

If you are implementing [**Unified Login**](/docs/unified-login/introduction) with **OAuth2 Access Tokens**, you will have to [manually](/docs/unified-login/customizations/verify-tokens) validate tokens.
