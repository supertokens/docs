...
The full signature of [`createNewSession`](https://supertokens.io/docs/nodejs/interfaces/recipe_session.RecipeInterface.html#createNewSession) is:
```jsx
...
The full signature of [`createNewSession`](/docs/golang/session/createnewsession) is:
```go
CreateNewSession(responseWriter, userId, jwtPayload, sessionData)
```
