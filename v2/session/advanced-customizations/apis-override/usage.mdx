...
We first need to find the implementation for the signOutPOST this can be found [here](https://github.com/supertokens/supertokens-node/blob/master/lib/ts/recipe/session/api/implementation.ts#L48).
