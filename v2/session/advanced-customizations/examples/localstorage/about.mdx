...
This may be necessary if you want your API and website base domains are different (e.g.: api.example.com and xyz.com), because
in this case Safari blocks our cookies. This is not the recommended solution, for more details please check out [this issue](https://github.com/supertokens/supertokens-core/issues/280).
