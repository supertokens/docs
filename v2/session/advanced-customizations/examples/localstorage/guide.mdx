...
We can do this by adding it to `allowedHeaders` in the cors config, as seen in [line 125](https://github.com/supertokens/supertokens-auth-react/blob/localstorage-example/examples/with-localstorage/api-server.js#L125).
...
You can find the implementation in the [updateHeaders function](https://github.com/supertokens/supertokens-auth-react/blob/localstorage-example/examples/with-localstorage/api-server.js#L14-L30).
...
You can find the modified session recipe config in [lines 43-116](https://github.com/supertokens/supertokens-auth-react/blob/localstorage-example/examples/with-localstorage/api-server.js#L43-L116)
...
You can find a simple implementation in [lines 126-155](https://github.com/supertokens/supertokens-auth-react/blob/localstorage-example/examples/with-localstorage/src/App.js#L126-L155).
...
You can see how we did it in [lines 73-101](https://github.com/supertokens/supertokens-auth-react/blob/localstorage-example/examples/with-localstorage/src/App.js#L73-L101)
...
[lines 116-121](https://github.com/supertokens/supertokens-auth-react/blob/localstorage-example/examples/with-localstorage/src/App.js#L116-L121).
...
You can see a basic implementation in [lines 33-71](https://github.com/supertokens/supertokens-auth-react/blob/localstorage-example/examples/with-localstorage/src/App.js#L33-L71).
