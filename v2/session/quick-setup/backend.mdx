...
- `POST ^{form_apiBasePath}/refreshh`: It is used to get a new refresh and access token in case the older one expires.
- `POST ^{form_apiBasePath}/signouth`: It is used sign out the currently logged in user.
