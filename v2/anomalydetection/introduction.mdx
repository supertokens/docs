...
Once our team sets this up for you, you will receive from us:
- **Public API key** - this will be used on your frontend for generating request IDs
- **Service access key** - this will be used on your backend for making requests to our anomaly detection API
