...
If you want to use an authentication flow that relies on the [**PKCE**](/docs/oauth/introduction#pkce) you will have to set the following parameter in the request body `"tokenEndpointAuthMethod": "none"`.
...
- [Single Backends Setup](/docs/oauth/multiple-frontends-with-a-single-backend)
