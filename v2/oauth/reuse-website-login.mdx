...
- `responseTypes` - Specifies the types of responses your client expects from the [**Authorization Server**](/docs/oauth/introduction#authorization-server). Most of the time, you would need the following two to be present:
...
- [Single Backend Setup](/docs/oauth/multiple-frontends-with-a-single-backend#3-set-up-your-authorization-service-backend)
- [Multiple Backends Setup](/docs/oauth/multiple-frontends-with-separate-backends#3-set-up-your-authorization-service)
...
- `serviceConfiguration.authorizationEndpoint` corresponds to `authorizeUrl`
- `serviceConfiguration.tokenEndpoint` corresponds to `tokenFetchUrl`
