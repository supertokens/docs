...
- `emails`:  adds the `emails` claim into the **ID Token** and the **User Info**. It includes all the emails associated with that user.
- `phoneNumbers`: adds the `phoneNumbers` claim into the **ID Token** and the **User Info**. It includes all the phone numbers associated with that user.
