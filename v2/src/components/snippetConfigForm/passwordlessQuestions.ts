...
export const passwordlessQuestions: Record<string, QuestionInfo<any>> = {
    ...
    options: [
      {
        ...
        value: "PHONE",
        variableMap: {
          sendCB_Go: `ContactMethodPhone: plessmodels.ContactMethodPhoneConfig{
    Enabled: true,
},`,
      ...
      },
      {
        ...
        value: "EMAIL",
        variableMap: {
          sendCB_Go: `ContactMethodEmail: plessmodels.ContactMethodEmailConfig{
    Enabled: true,
},`,
      ...
      },
      {
        ...
        variableMap: {
          sendCB_Go: `ContactMethodEmailOrPhone: plessmodels.ContactMethodEmailOrPhoneConfig{
    Enabled: true,
},`,
  ...
  flowType: {
    ...
    options: [
      {
        title: "OTP",
        activeText: "Your users will authenticate by typing in an OTP.",
      ...
      },
      {
        ...
        activeText:
          "Your users will authenticate by typing an OTP or clicking a magic link.",
