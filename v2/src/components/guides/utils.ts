...
export const FRAMEWORKS_WITH_ONLY_CUSTOM_UI: FrontendChoice[] = [
  "vanillajs",
  "react-native",
  "ios",
  "android",
...
export function getSelection(search?: string): Selection | undefined {
  if (typeof window !== "undefined") {
    let queryParams = new URLSearchParams(search || window.location.search);
