...
export default class CompatibilityMatrix extends React.PureComponent<Props, State> {
    ...
    getFrameworkDropdown = () => {
        return (
            <div className="compatibility-select-container">
                <div className="compatibility-select-title">Select a backend SDK</div>

                <select onChange={this.onDriverSelected} value={this.state.selectedDriver}>
    ...
    getDatabaseDropdown = () => {
        return (
            ...
            >
                <div className="compatibility-select-title">Select a database</div>
                ...
                <select onChange={this.onPluginSelected} value={this.state.selectedPlugin}>
                    <option key="placeholder" value="" disabled hidden>
                        Please select
                    </option>
    ...
    getFrontendDropdown = () => {
        return (
            <div
                ...
                className="compatibility-select-container"
            >
                <div className="compatibility-select-title">Select a frontend SDK</div>

                <select onChange={this.onFrontendSelected} value={this.state.selectedFrontend}>
                    <option key="placeholder" value="" disabled hidden>
                        Please select
                    </option>
    ...
    getTableHeader = (firstTitle: string, secondTitle: string, firstHoverText: string, secondHoverText: string) => {
        return (
            <div className="compatibility-table-header-row">
                <div
                    style={{
                ...
                >
                    <div className="compatibility-table-header-text">{firstTitle}</div>
                </div>
                ...
                <div
                    ...
                    className="compatibility-table-header"
                >
                    <div className="compatibility-table-header-text">{secondTitle}</div>
                </div>
            </div>
        );
    };
    ...
    getCoreToDriver = () => {
        ...
        return (
            <div className="compatibility-table-section-container">
                <div className="compatibility-table">
                    ...
                    {Object.keys(this.state.compatibilityData.coreToDriver).map((key, index) => {
                        ...
                        return (
                            <div className="compatibility-table-row">
                                <div
                                    style={{
    ...
    render() {
        ...
        return (
            <div id="compatibility-root">
                ...
                {this.state.shouldShowCompatibility && this.getDivider()}

                {this.state.shouldShowCompatibility && this.getCompatibilityContent()}
            </div>
        );
    }
    ...
    fetchPageData = async () => {
        try {
            ...
            let driversResponse = await getSupportedDrivers();
    ...
    fetchCompatibilityIfNeeded = async () => {
        ...
        try {
            const compatibilityResponse = await getCompatibility(
                this.state.selectedDriver,
                this.state.selectedFrontend
            );
            this.setState(oldState => ({
