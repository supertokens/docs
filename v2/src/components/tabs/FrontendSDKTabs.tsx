        ...
        <Answer title="Prebuilt UI">
          <div className="admonition admonition-caution alert alert--warning">
            ...
            <div className="admonition-content">
              SuperTokens does not have a dedicated SDK for Angular. Instead we will be using the <code>supertokens-auth-react</code> SDK to render the login UI. Therefore, the code snippet below refers to the <code>supertokens-auth-react</code> SDK.
            </div>
          </div>
          <div>
            ~COPY-TABS=reactjs
