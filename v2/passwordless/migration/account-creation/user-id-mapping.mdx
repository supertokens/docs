...
## Map your users' existing userId to their new SuperTokens userId.

For example:

With the users' SuperTokens userId as `fa7a0841-b533-4478-95533-0fde890c3483` and externalId as `customUserId`.
