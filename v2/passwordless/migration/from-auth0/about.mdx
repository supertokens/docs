...
- If you have stored a user's Auth0 `userId` in your database, you need to map the user's Auth0 `userId` with their SuperTokens `userId` during login using SuperTokens' UserId Mapping feature.
