...
For custom UI SuperTokens provides no login UI, the code above will reidrect the user to the `/auth` route but you will have to build some UI that is served on that route.
:::
