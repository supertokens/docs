...
- `POST /auth/signup/email/exists`: To check if an email is already signed up
- `POST /auth/signup/phonenumber/exists`: To check if a phonenumber is already signed up
