...
function MyAuthPage() {
    ...
    return (
        <div>
            <Header />
            // highlight-next-line
            <AuthPage preBuiltUIList={[PasswordlessPreBuiltUI]} navigate={navigate} />
            <Footer />
        </div>
    );
}
...
function MyAuthPage() {
    ...
    return (
        <div>
            <Header />
            // highlight-next-line
            <AuthPage preBuiltUIList={[PasswordlessPreBuiltUI]} navigate={history} />
            <Footer />
        </div>
    );
}
...
function MyAuthPage() {
    return (
        <div>
            <Header />
            // highlight-next-line
            <AuthPage preBuiltUIList={[PasswordlessPreBuiltUI]} />
            <Footer />
        </div>
    )
}
