...
You can change how long a user can use an OTP or a Magic Link to log in by changing the `passwordless_code_lifetime` configuration value. 

This value is set in milliseconds and defaults to `900000` (15 minutes).
