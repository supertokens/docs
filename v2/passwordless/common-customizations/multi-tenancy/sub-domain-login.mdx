...
After you have shown the login methods and the user tries to sign in, you have to follow all the steps for mobile app login mentioned in the [passwordless login steps](../../custom-ui/login-magic-link), except that when you are calling the APIs, you also need to pass in the tenantId in the request path. An example of this is shown below:
