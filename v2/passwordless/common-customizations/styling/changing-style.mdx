...
This section will guide you through an example of updating the look of buttons. Note that the process can be applied to update any HTML tags from within SuperTokens components.
...
This screen is shown if your user successfully logged in on another tab, while 
