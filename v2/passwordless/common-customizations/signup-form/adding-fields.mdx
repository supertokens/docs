...
<img src="/img/passwordless/signup-with-name-and-age.png" />

:::tip
Please refer to the <a href="/docs/auth-react/passwordless/config/sign-up#signupform-config-values" target="_blank">auth-react reference API</a>  for more information about adding custom fields.
:::
