...
func main() {
	...
	userInfo, err := passwordless.GetUserByEmail("test@example.com", nil)
	if err != nil {
		// TODO: Handle error
		return
	}
...
func main() {
	...
	userInfo, err := passwordless.GetUserByPhoneNumber("+1234567890", nil)
	if err != nil {
		// TODO: Handle error
		return
	}
...
func getUserInfoAPI(w http.ResponseWriter, r *http.Request) {
	...
	// highlight-next-line
	userInfo, err := passwordless.GetUserByID(userID, nil)
	if err != nil {
		// TODO: Handle error
		return
	}
