...
// Note that usersInfo has type User[]
// You can learn more about the `User` object over here https://github.com/supertokens/core-driver-interface/wiki
let usersInfo = await ^{recipeNameCapitalLetters}.getUserByPhoneNumber("+36701234567");
...
func main() {
    ...
    // Note that usersInfo has type User[]
    // You can learn more about the `User` object over here https://github.com/supertokens/core-driver-interface/wiki 
	usersInfo, err := ^{codeImportRecipeName}.GetUserByPhoneNumber("test@example.com")
	if err != nil {
		// TODO: Handle error
		return
	}
...
# Note that users_info has type List[User]
# You can learn more about the `User` object over here https://github.com/supertokens/core-driver-interface/wiki 
users_info = await get_user_by_phone_number("test@example.com")
```
...
# Note that users_info has type List[User]
# You can learn more about the `User` object over here https://github.com/supertokens/core-driver-interface/wiki 
users_info = get_user_by_phone_number("test@example.com")
```
