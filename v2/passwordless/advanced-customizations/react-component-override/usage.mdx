...
1. You will have to use the `PasswordlessComponentsOverrideProvider` component as shown below. make sure that it render the SuperTokens components inside this component.
