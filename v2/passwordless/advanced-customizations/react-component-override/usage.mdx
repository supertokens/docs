...
<img src="/img/passwordless/react-override-octocat.png" />
...
For the full list of components available for override in `Passwordless` recipe, refer to
[auth-react Passwordless override docs](/docs/auth-react/passwordless/override/components).
