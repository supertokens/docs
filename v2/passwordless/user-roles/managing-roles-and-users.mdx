...
:::tip
Roles can also be assigned and removed from a user from the user management dashboard, to know more about how to manage your user roles and permissions from user management dashboard look <a href="/docs/userdashboard/managing-user-roles-and-permissions" target="_blank">here</a>
:::
...
:::tip
You can also see all the roles that are assigned to a user from the user manangement dashboard on the user details page for that particular user, to know more about how to manage your user roles and permissions from user management dashboard look <a href="/docs/userdashboard/managing-user-roles-and-permissions" target="_blank">here</a>
:::
