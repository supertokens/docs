...
from supertokens_python.recipe.^{codeImportRecipeName}.types import TwilioOverrideInput, SMSTemplateVars
    ...
    recipe_list=[
        ^{codeImportRecipeName}.init(
            ...
            sms_delivery=SMSDeliveryConfig(
                service=^{codeImportRecipeName}.TwilioService(
                    # type: ignore
