...
import (
    ...
    "github.com/supertokens/supertokens-golang/recipe/^{codeImportRecipeName}/smsdelivery/twilioService"
    "github.com/supertokens/supertokens-golang/supertokens"
)

func main() {
    // highlight-start
    smsService, err := twilioService.MakeTwilioService(smsdelivery.TwilioTypeInput{
