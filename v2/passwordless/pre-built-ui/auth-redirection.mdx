...
By default, the user is redirected to the `/` route on your website post login. To change this, you can use the `getRedirectionURL` function on the frontend as shown below:
