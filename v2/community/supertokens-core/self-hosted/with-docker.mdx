...
```jsx
docker run -p 3567:3567 -d registry.supertokens.com/supertokens/supertokens-mysql
```
...
```bash
docker run -p 3567:3567 -d registry.supertokens.com/supertokens/supertokens-postgresql
```
...
```bash
docker run -p 3567:3567 -d registry.supertokens.com/supertokens/supertokens-mongodb
```
