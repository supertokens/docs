...
docker run \
    ...
    -d registry.supertokens.com/supertokens/supertokens-mysql
```
</TabItem>
...
docker run \
    ...
    -d registry.supertokens.com/supertokens/supertokens-postgresql
```
</TabItem>
...
docker run \
    ...
    -d registry.supertokens.com/supertokens/supertokens-mongodb
```
