...
:::important
If you decide to disable the fetch interception, then methods such as `getJWTPayload` may stop working as those use fetch. So you will also have to `override` those functions to use `axios` instead
:::
