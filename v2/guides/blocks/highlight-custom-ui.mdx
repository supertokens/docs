...
Use the demo app for a guideline on how everything should work and check our <GuideRecipeLink link="custom-ui/init/frontend">page</GuideRecipeLink> that shows how authentication methods should look like on the frontend. 
:::
