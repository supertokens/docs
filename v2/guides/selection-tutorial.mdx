...
<Condition
  match={selection => selection.hasExampleApp}
  title="Has Example App"
>
...
Over this base architecture, we enable different authentication functionalities by using **recipes**. This term is used to represent a feature that you can add to your application, using **SuperTokens**.
Things like [ *email/password login* ](/recipe), [*multi-factor authentication*](/recipe) or [ *session management* ](/recipe) are referred to as *recipes*. 
