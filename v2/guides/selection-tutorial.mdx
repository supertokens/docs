...
- The Node.js/Go/Python server will expose the authentication routes. It will use our **Backend SDK** to complete the authentication flows and communicate with the **SuperTokens Core Service**.
...
<Condition title="Default App Structure" match={true}>
...
<Condition title="Does not have a Starter Project" match={true}>
