...
## How will the CLI work?
- We will have the same options method that we have for this guide
- The supertokens config code will have to be generated dynamically from the CLI. So we will have to sort of create a file with the appropriate config.
- As for the frontend, we will have to make individual files for each type of login method, and then fuse them together in the frontend code to create a login UI that has all the different types of login methods. We can have like a 
