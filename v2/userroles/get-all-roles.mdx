...
:::tip
You can easily see all the roles related to a particular app and can also perform various operations on them from the user management dashboard itself. To know more about how to manage your user roles and permissions from user management dashboard look <a href="/docs/userdashboard/managing-user-roles-and-permissions" target="_blank">here</a>
:::
