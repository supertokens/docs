...
You can also add, remove and edit permissions for a role from the user management dashboard. To know more about how to manage your user roles and permissions from user management dashboard see [this page](/docs/userdashboard/managing-user-roles-and-permissions)
