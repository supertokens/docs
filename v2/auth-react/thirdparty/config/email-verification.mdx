...
- `style` 
    ...
    - Please refer to the [common customizations guide](/docs/thirdparty/common-customizations/styling/changing-style) for more information about how the styles.
