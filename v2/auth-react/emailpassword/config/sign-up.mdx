...
### `style` 
- An object to overwrite the Sign up form styles. Please refer to the [common customizations guide](/docs/emailpassword/common-customizations/styling/changing-colours) for more information about how to update the sign up form style.
- Example: 
    ```jsx
    style: {
        container: {
