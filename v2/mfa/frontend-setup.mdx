...
- This can happen when the second factor is `emailpassword`:
    ...
    - Output JSON:
        ...
        {
            "status": "SIGN_IN_NOT_ALLOWED",
            "reason": "Cannot sign in due to security reasons. Please contact support. (ERR_CODE_011)"
        }
        ```
- An example scenario of when in the following scenario:
...
- This can happen when the second factor is `emailpassword`:
    ...
    - Output JSON:
        ...
        {
            "status": "SIGN_IN_NOT_ALLOWED",
            "reason": "Cannot sign in due to security reasons. Please contact support. (ERR_CODE_012)"
        }
        ```
- An example scenario of when in the following scenario:
