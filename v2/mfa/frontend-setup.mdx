...
- First the frontend needs to check the values of the `n` array. If this array is empty, then the user has completed MFA. If there are multiple values in this array, then the frontend needs to show these options to the user and ask them to pick one of them.
- TODO..
