---
id: first-factor
title: "Setting up the first factor (backend)"
hide_title: true
---
...
# Setting up the first factor (backend)

## Initialisation on the backend
...
:::important
You should have also added the SuperTokens `middleware` and `errorHandler` (if applicable) to your application. We are not showing it in the above code snippet for brevity, but it is explained in the ThirdPartyEmailPassword recipe guide. 
:::

## Storing first factor completion information in the session
