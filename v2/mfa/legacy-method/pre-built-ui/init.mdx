...
To start, we want to initialise the [ThirdParty + EmailPassword](https://supertokens.com/docs/thirdpartyemailpassword/quick-setup/frontend) and the [Passwordless](https://supertokens.com/docs/passwordless/quick-setup/frontend) recipes as mentioned in their quick setup section:
