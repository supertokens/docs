...
If you have correctly followed the frontend setup guide in the [ThirdPartyEmailPassword recipe](https://supertokens.com/docs/thirdpartyemailpassword/quick-setup/frontend), you should see the login UI when you visit `^{form_websiteDomain}^{form_websiteBasePath}`. 
