...
If you have correctly followed the frontend setup guide in the [ThirdParty + EmailPassword recipe](https://supertokens.com/docs/thirdpartyemailpassword/quick-setup/frontend), you should see the login UI when you visit `^{form_websiteDomain}^{form_websiteBasePath}`. 
    ...
    recipeList: [
        Passwordless.init({
            ...
            signInUpFeature: {
                ...
                // visit ^{form_websiteDomain}^{form_websiteBasePath}
...
## 4) Display the second factor component on your app's router
