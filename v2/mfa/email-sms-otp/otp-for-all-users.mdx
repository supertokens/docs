...
In the **Tenant Management** section of the dashboard and select the tenant you wish to update.

Enable **Email Password** and **Third Party** Login methods section.

Enable **OTP - Email** in the Secondary Factors Section.
