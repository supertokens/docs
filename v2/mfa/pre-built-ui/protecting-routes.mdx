...
Finally, we check the result of the validation in the `InvalidClaimHandler` component which displays `"You cannot access this page because you have not completed both factors."` if the `SecondFactorClaim` claim failed.
