        ...
        apis: (originalImplementation) => {
            return {
                ...
                signUpPOST: async function (input) {
                    let email = input.formFields.find((field) => field.id === "email")!.value;
					...
					APIs: func(originalImplementation epmodels.APIInterface) epmodels.APIInterface {
						...
						(*originalImplementation.SignUpPOST) = func(formFields []epmodels.TypeFormField, tenantId string, options epmodels.APIOptions, userContext supertokens.UserContext) (epmodels.SignUpPOSTResponse, error) {
							...
							for _, formField := range formFields {
								// NOTE: The check for type of email will never actually
								...
								if formField.ID == "email" {
									...
									if !asStrOk {
										return epmodels.SignUpPOSTResponse{
											GeneralError: &supertokens.GeneralErrorResponse{Message: "email value needs to be a string"},
										}, nil
									}
									email = valueAsString
								}
        ...
        apis: (originalImplementation) => {
            return {
                ...
                signInPOST: async function (input) {
                    ...
                    let email = input.formFields.find((field) => field.id === "email")!.value;
                    let password = input.formFields.find((field) => field.id === "password")!.value;
								...
								if formField.ID == "email" || formField.ID == "password" {
									...
									if !asStrOk {
										return epmodels.SignInPOSTResponse{
											GeneralError: &supertokens.GeneralErrorResponse{Message: fmt.Sprintf(`%s value needs to be a string`, formField.ID)},
										}, nil
									}
									if formField.ID == "email" {
										email = valueAsString
