            ...
            return {
                ...
                emailPasswordSignIn: async function (input) {
                    ...
                    if (emailPasswordUser === undefined) {
                        ...
                        let signUpResponse = await ThirdPartyEmailPassword.emailPasswordSignUp(input.tenantId, input.email, input.password, input.userContext);
                ...
                generatePasswordResetTokenPOST: async (input) => {
                    ...
                    if (emailPasswordUser === undefined) {
                        ...
                        if (legacyUserData) {
                            ...
                            let signupResponse = await ThirdPartyEmailPassword.emailPasswordSignUp(input.tenantId, email, tempPassword, input.userContext);
