...
title: User migration without password hahes
hide_title: true
---
# User migration without password hahes

:::caution
The recommended method for migrating users to SuperTokens is by [importing users with their password hashes](./user-creation).
You should only use the following method if you do not have access to your user's password hashes
:::
...
You will also need to override the password reset flow to account for users who have forgotten their passwords.
