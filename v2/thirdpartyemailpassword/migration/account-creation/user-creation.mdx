...
:::important
If you do not have access to your user's password hashes, you can use the [following guide](./ep-migration-without-password-hash) to migrate user's from the external authentication provider to SuperTokens. 
:::
