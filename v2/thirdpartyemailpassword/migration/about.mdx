...
### User ID Mapping
- SuperTokens provides an API which allows you to map a custom userId with a SuperTokens userId. This will allow you to keep the existing userIds in your application's table.
