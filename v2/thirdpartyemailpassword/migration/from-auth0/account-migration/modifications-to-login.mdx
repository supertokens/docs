...
To get started, you will first need to setup SuperTokens on your frontend and backend. You can do so by following this [guide](/docs/thirdpartyemailpassword/quick-setup/video-tutorial)
