...
- If you have stored a users Auth0 userId in your database, you can continue to use that data by mapping the users Auth0 userId with their SuperTokens userId during login.
