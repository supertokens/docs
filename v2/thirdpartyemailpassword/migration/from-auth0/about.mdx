...
- If you have stored a user's Auth0 `userId` in your database, you can continue to use that data by mapping the user's Auth0 `userId` with their SuperTokens `userId` during login.
