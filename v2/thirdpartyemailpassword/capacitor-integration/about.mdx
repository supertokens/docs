...
The project uses Social Login + Email Password for auth using `supertokens-web-js`, but you can easily change this to use other recipes by following our quick setup guide for custom UI.