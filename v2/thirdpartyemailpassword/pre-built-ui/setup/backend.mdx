...
<!-- COPY DOCS -->
<!-- ./thirdpartyemailpassword/pre-built-ui/setup/backend.mdx -->
...
## Other Frameworks
Learn how to [implement SuperTokens in an unsupported backend framework here](../common-customizations/other-frameworks).

## 1) Install

<BackendSDKTabs otherFrameworks>
...
You can learn how to [implement SuperTokens in an unsupported backend framework here](../common-customizations/other-frameworks).
