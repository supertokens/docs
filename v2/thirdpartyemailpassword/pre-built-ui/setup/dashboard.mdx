...
<!-- COPY DOCS -->
<!-- ./thirdpartyemailpassword/pre-built-ui/setup/dashboard.mdx -->
...
# Starting the user management dashboard
...
Now, navigate to the your frontend app and create a user. On creation, if you head back to the dashboard and refresh the page, you will see that user:
