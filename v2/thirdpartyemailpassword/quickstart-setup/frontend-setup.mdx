...
import FrontendCustomUIEmailPasswordSingUp from '../../community/reusableMD/custom-ui/frontend-custom-ui-email-password-sign-up.mdx'
import FrontendCustomUIEmailPasswordSingIn from '../../community/reusableMD/custom-ui/frontend-custom-ui-email-password-sign-in.mdx'
...
<!-- COPY SECTION -->
<!-- ./emailpassword/quickstart-setup/frontend-setup.mdx -->
<!-- 3 -->
...
## 3. Add the Login UI for the Email/Password Flow
...
<FrontendCustomUIEmailPasswordSingUp />

### 3.2 Add the Sign In Form

<FrontendCustomUIEmailPasswordSingIn />

## 4. Add the Login UI for the ThirdParty Flow
