...
:::tip
Roles can also be created from the user management dashboard, to know more about how to manage your user roles and permissions from user management dashboard look [here](/docs/userdashboard/managing-user-roles-and-permissions).
:::
