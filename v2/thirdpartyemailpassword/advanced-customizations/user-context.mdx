...
from supertokens_python.recipe.thirdpartyemailpassword.interfaces import APIInterface, EmailPasswordAPIOptions, RecipeInterface, ThirdPartySignInUpOkResult
