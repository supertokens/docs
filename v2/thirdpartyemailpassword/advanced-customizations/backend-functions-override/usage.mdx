...
:::info
See all the [functions that can be overrided here](https://supertokens.io/docs/nodejs/interfaces/recipe_thirdpartyemailpassword.RecipeInterface.html)
:::
			...
			thirdpartyemailpassword.Init(&tpepmodels.TypeInput{
				...
				Override: &tpepmodels.OverrideStruct{
					Functions: func(originalImplementation tpepmodels.RecipeInterface) tpepmodels.RecipeInterface {
						...
						newImplementation.SignInUp = func(thirdPartyID, thirdPartyUserID string, email tpepmodels.EmailStruct) (tpepmodels.SignInUpResponse, error) {
							// TODO: some custom logic
...
:::info
See all the [functions that can be overrided here](https://supertokens.io/docs/python/recipe/thirdpartyemailpassword/interfaces.html#supertokens_python.recipe.thirdpartyemailpassword.interfaces.RecipeInterface)
:::

```python

# highlight-start
def override_thirdpartyemailpassword_functions(original_implementation):
	...
	async def sign_in_up(third_party_id: str, third_party_user_id: str, email: str,
		...
		# or call the default behaviour as show below
		return await original_sign_in_up(third_party_id, third_party_user_id, email, email_verified)
