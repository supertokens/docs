...
:::info
See all the [functions that can be overrided here](/docs/golang/thirdpartyemailpassword/override/apis)
:::
...
You first need to find the implementation for the API you would like to change in the backend SDK.
- All the APIs you can override can be found [here](/docs/golang/thirdpartyemailpassword/override/apis), copy the name of the function you would like to override.
