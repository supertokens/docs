...
We first need to find the implementation for the passwordResetPOST, this can be found [here](https://github.com/supertokens/supertokens-node/blob/master/lib/ts/recipe/thirdpartyemailpassword/api/implementation.ts#L43). Since this API uses the EmailPassword recipe API make sure to copy the code from [here](https://github.com/supertokens/supertokens-node/blob/master/lib/ts/recipe/emailpassword/api/implementation.ts#L74)
