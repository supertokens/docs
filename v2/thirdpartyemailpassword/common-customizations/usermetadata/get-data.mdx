...
<!-- COPY DOCS -->
<!-- ./session/common-customizations/usermetadata/get-data.mdx -->
...
You can get the full metadata object of a user through the `UserMetadata.getUserMetadata` method using their `userId`.

:::important
This will return an empty metadata object for unknown ids.
:::
