        ...
        <SessionAuth 
            ...
            overrideGlobalClaimValidators={(globalValidators) => [
                ...globalValidators,
                {
                    ...
                    // It may still show up if other validators are failing and none required a redirection.
...
1. Show an access-denied screen. This can be enabled by passing a component as the `accessDeniedScreen={AccessDeniedScreen}` prop to `SessionAuth`. We provide a built-in component you can use as a default, but you can use a fully custom component as well.
2. Redirect the user to a specific page by adding `onFailureRedirection`. Claims requiring redirection take priority over showing the access denied screen.
Both of these options are showcased in the combined example above.
