...
def logout():
    ...
    session.revoke_session()) # This will delete the session from the db and from the frontend (cookies)
    # highlight-end
    return 'success'
...
async def logout(request):
    session = request.supertokens # This will delete the session from the db and from the frontend (cookies)
    # highlight-end
...
func main() {
	...
	// highlight-next-line
	revoked, err := session.RevokeSession(sessionHandle, nil)
	if err != nil {
		// TODO: Handle error
		return
	}
...
# highlight-next-line
revoked = await revoke_session(session_handle)
```
...
func main() {
	// highlight-next-line
	revokedSessionHandles, err := session.RevokeAllSessionsForUser("userId", nil)
	if err != nil {
		// TODO: Handle error
		return
	}
