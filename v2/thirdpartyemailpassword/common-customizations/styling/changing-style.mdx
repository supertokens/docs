...
<img alt="Inspecting element to be used for customization" width="500px" src="/img/emailpassword/inspect-button.png" />
...
<img alt="Prebuilt form with custom submit button" width="500px" src="/img/thirdpartyemailpassword/signup-centered-blue-button.png" />
