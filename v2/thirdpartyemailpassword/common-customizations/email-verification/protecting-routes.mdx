...
### Protecting specific frontend routes
...
<details><summary>Manually checking verification status</summary>
If you are not using the `SessionAuth` wrapper or want to have more complex access control, you can either create your own validator, or you can get the boolean from the session as follows, and check it yourself:
