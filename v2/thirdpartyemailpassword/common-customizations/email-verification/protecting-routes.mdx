...
<details><summary>Handling 403 responses</summary>
If your frontend queries a protected API on your backend and it fails with a 403, you can check 
If a call to a protected API to your backend fails on the frontend you can you can loop through the errors to know which claim has failed:
