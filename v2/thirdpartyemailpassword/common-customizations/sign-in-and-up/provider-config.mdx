...
import (
    ...
    "github.com/supertokens/supertokens-golang/recipe/thirdparty/^{goModelName}"
...
func main() {
	supertokens.Init(supertokens.TypeInput{
		RecipeList: []supertokens.Recipe{
			thirdparty.Init(^{goModelNameForInit}.TypeInput{
                ...
                providers=[
                    ProviderInput(
                        config=ProviderConfig(
                            ...
                            oidc_discovery_endpoint="https://login.microsoftonline.com/<directoryId>/v2.0",
                        ),
                    ),
                ]
            ^{pythonsignInUpFeatureEnd}
                ...
                providers=[
                    ProviderInput(
                        config=ProviderConfig(
                            ...
                            oidc_discovery_endpoint="https://dev-<id>.okta.com",
                        ),
                    ),
                ]
            ^{pythonsignInUpFeatureEnd}
                ...
                providers=[
                    ProviderInput(
                        config=ProviderConfig(
                            ...
                            oidc_discovery_endpoint="https://gitlab.example.com"
                        ),
                    ),
                ]
            ^{pythonsignInUpFeatureEnd}
