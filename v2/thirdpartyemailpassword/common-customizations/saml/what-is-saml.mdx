...
In a nutshell, your SAML identity provider will provide a signing certification (which is a .xml file) which you or your end users need to upload to the SAML client (i.e. to SuperTokens or any other SAML client you use).
