...
from supertokens_python.recipe.^{rid}.interfaces import ^{codeSignInWrongCredentialsErrorResultPythonType}
from flask import g
...
def change_password():
    ...
    if isinstance(isPasswordValid, ^{codeSignInWrongCredentialsErrorResultPythonType}):
        # TODO: handle incorrect password error
        return
