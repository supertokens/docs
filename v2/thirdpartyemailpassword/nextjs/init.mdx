...
const appInfo = {
  ...
  appName: 'My Awesome App', // TODO: Your app name
...
- [Google](https://developers.google.com/identity/sign-in/web/sign-in#create_authorization_credentials) (Authorisation callback URL is `{websiteDomain}/auth/callback/google`)
- [Facebook](https://developers.facebook.com/docs/development/create-an-app) (Authorisation callback URL is `{websiteDomain}/auth/callback/facebook`)
