...
Before we initialize the `supertokens-auth-react` SDK lets see how we will use it our Angular app
...
```tsx {15-23} title="/app/auth/auth.component.ts"
...
```tsx {7-11} title="/app/app.component.ts "
