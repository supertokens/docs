...
func main() {
	err := supertokens.Init(supertokens.TypeInput{
		...
		RecipeList: []supertokens.RecipeListFunction{
			thirdpartyemailpassword.Init(&models.TypeInput{
				Providers: []tpm.TypeProvider{
					thirdpartyemailpassword.Google(providers.GoogleConfig{
						ClientID:     "GOOGLE_CLIENT_ID",
						ClientSecret: "GOOGLE_CLIENT_SECRET",
					}),
					thirdpartyemailpassword.Github(providers.GithubConfig{
						ClientID:     "GITHUB_CLIENT_ID",
						ClientSecret: "GITHUB_CLIENT_SECRET",
					}),
					thirdpartyemailpassword.Facebook(providers.FacebookConfig{
						ClientID:     "FACEBOOK_CLIENT_ID",
						ClientSecret: "FACEBOOK_CLIENT_SECRET",
					}),
				},
