...
ThirdPartyEmailPassword.init({
    ...
    providers: [
        Google({
            clientSecret: "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", // TODO:
            clientId: "1060725074195-kmeum4crr01uirfl2op9kd5acmi9jutn.apps.googleusercontent.com" // TODO:
        }),
        Github({
            clientSecret: "97051221f4b6426e8fe8d51486396703012f5bd", // TODO:
            clientId: "467101b197249757c71f" // TODO:
        }),
        // Facebook({
...
thirdpartyemailpassword.init({
    ...
    'providers': [
        ...
        Github({
            client_id: "GITHUB_CLIENT_ID", // TODO:
            client_secret: "GITHUB_CLIENT_SECRET", // TODO:
        }),
        Facebook({
...
:::caution 
- To help users get started quickly, SuperTokens provides development OAuth credentials for Google and Github.
- These development keys are to be used for **testing puroposes only**, make sure to use valid credentials in production.
:::
