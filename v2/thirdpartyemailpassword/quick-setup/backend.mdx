...
- Apple:
    - Generate your client ID and secret by following [this article](https://developer.okta.com/blog/2019/06/04/what-the-heck-is-sign-in-with-apple)
    - Set the authorisation callback URL to `^{form_apiDomain}/auth/callback/apple`
