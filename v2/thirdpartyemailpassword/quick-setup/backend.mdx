...
:::important
Make sure to add the full website URL when setting up CORS for you backend. For example, if your website domain is `example.com` make sure the website URL value is set to `https://example.com`.
:::
