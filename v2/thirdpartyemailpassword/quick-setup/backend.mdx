		...
		RecipeList: []supertokens.RecipeListFunction{
			thirdpartyemailpassword.Init(&tpepmodels.TypeInput{
				Providers: []tpmodels.TypeProvider{
					thirdpartyemailpassword.Google(tpmodels.GoogleConfig{
						ClientID:     "GOOGLE_CLIENT_ID",
						ClientSecret: "GOOGLE_CLIENT_SECRET",
					}),
					thirdpartyemailpassword.Github(tpmodels.GithubConfig{
						ClientID:     "GITHUB_CLIENT_ID",
						ClientSecret: "GITHUB_CLIENT_SECRET",
					}),
					thirdpartyemailpassword.Facebook(tpmodels.FacebookConfig{
						ClientID:     "FACEBOOK_CLIENT_ID",
						ClientSecret: "FACEBOOK_CLIENT_SECRET",
					}),
				},
