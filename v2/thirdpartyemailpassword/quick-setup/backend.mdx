...
- [Google](https://developers.google.com/identity/sign-in/web/sign-in#create_authorization_credentials), (callback URL is `^{form_websiteDomain}/auth/callback/google`)
- [Github](https://docs.github.com/en/developers/apps/creating-an-oauth-app), (callback URL is `^{form_websiteDomain}/auth/callback/github`)
- [Facebook](https://developers.facebook.com/docs/development/create-an-app), (callback URL is `^{form_websiteDomain}/auth/callback/facebook`)
