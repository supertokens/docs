...
Create a new tenant by clicking on **Add Tenant** and then specify the Tenant ID. Once the tenant is created, enable the Login Methods required for that tenant.

<img src="/img/dashboard/tenant-management/enable-ep-tp.png" alt="Enable login methods"/>
...
<img src="/img/dashboard/tenant-management/create-thirdparty.gif" alt="Create Third Party Provider"/>
