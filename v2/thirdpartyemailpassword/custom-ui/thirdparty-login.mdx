...
This invloves setting up the [react-native-apple-authentication library](https://github.com/invertase/react-native-apple-authentication) in your app. Checkout their `README` for steps on how to integrate their SDK into your application.
...
:::important
For iOS the `client_id` should always match your app's bundle identifier.
:::
...
let providers = [
    // Used for web and android login. These credentials will be used if
