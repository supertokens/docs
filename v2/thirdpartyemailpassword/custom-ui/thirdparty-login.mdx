...
:::note
The same flow applies during sign up and sign in. If the user is signing up, the `createdNewUser` boolean on the backend will be true (as the result of the sign up API call).
:::
