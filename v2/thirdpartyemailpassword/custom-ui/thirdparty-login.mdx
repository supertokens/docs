...
This involves using Google's official auth SDK on Android, you can follow to steps [here](https://developers.google.com/identity/sign-in/android/start-integrating) to get started.

After you have finished following the guide you can use the following piece of code to start the sign in process (full docs [here](https://developers.google.com/identity/sign-in/android/sign-in#start_the_sign-in_flow))
...
After the user finishes the auth flow:
...
private void handleSignInResult(Task<GoogleSignInAccount> completedTask) {
    try {
        ...
        // Note this requires GoogleSignInOptions.Builder.requestServerAuthCode to be set up
        String authCode = account.getServerAuthCode();

        // TODO: Signed in successfully, call SuperTokens and send auth code
...
Google returns control back to your app using `onActivityResult`, `RC_SIGN_IN` is the result code you use to launch the Google login Intent. If the result of login with Google is successfull, you can call the `/signinup` (refer to the [fdi](https://supertokens.com/docs/fdi)) route exposed by the SuperTokens backend SDK and send the `authCode` from Google as part of the request body.
