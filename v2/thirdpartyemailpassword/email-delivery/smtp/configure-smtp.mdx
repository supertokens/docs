...
from supertokens_python.ingredients.emaildelivery.services.smtp import SMTPServiceConfig, SMTPServiceConfigFrom
from supertokens_python.ingredients.emaildelivery.types import EmailDeliveryConfig
from supertokens_python.recipe.^{codeImportRecipeName}.emaildelivery.services import smtp
from supertokens_python.ingredients.emaildelivery.services.smtp import EmailDeliverySMTPConfig
