...
This method allows you provide a callback using which you can send emails however you like. The input to the callback will the variable contents of the email, so you can freely design the email as well. Use this method if you are:
