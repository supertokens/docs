...
:::caution
If you set a custom apiBasePath, the refresh path will also be updated. For example, if you set the base path to SOME_PATH, the SDK will send a post request to apiDomain + SOME_PATH + "/refresh/session" when refreshing a session.
:::
