...
With the user management dashboard you can view the list users and there details that are part of your app and easily you can perform diffrent operations on the users as mentioned below.
