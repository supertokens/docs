...
We can do this by adding it to `allowedHeaders` in the cors config, as seen [here])(https://github.com/supertokens/supertokens-auth-react/blob/master/examples/with-localstorage/api-server.js#L125).
...
You can find the implementation [here](https://github.com/supertokens/supertokens-auth-react/blob/master/examples/with-localstorage/api-server.js#L14-L30).
...
You can find the modified session recipe [here](https://github.com/supertokens/supertokens-auth-react/blob/master/examples/with-localstorage/api-server.js#L43-L116)
...
A simple implementation can be found [here](https://github.com/supertokens/supertokens-auth-react/blob/master/examples/with-localstorage/src/App.js#L126-L155).
