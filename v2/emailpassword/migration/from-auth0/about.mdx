...
- We will be overriding the SuperTokens login function so that if a user logs into your app with with their Auth0 account credentials, their user data is retrived from Auth0 and a new SuperTokens account is created.
