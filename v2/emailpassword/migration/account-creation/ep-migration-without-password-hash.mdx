...
This flag is set in the password reset flow and it's relevance is described in [Step 3](#step-3-create-a-supertokens-account-for-users-who-have-an-account-with-the-external-provider-but-have-forgotten-their-password).
