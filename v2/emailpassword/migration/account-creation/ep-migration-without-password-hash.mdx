            ...
            return {
                ...
                signIn: async function (input) {
                    ...
                    if (supertokensUser === undefined) {
                        ...
                        let signUpResponse = await EmailPassword.signUp(input.tenantId, input.email, input.password, input.userContext)
                ...
                generatePasswordResetTokenPOST: async (input) => {
                    ...
                    if (supertokensUser === undefined) {
                        ...
                        if (legacyUserInfo) {
                            ...
                            let signUpResponse = await EmailPassword.signUp(input.tenantId, email, tempPassword, input.userContext);
