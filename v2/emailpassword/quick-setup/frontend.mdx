...
Use `EmailPasswordAuth` component in order to protect authenticated parts of your application:
...
import EmailPassword, {__HIGHLIGHT_PHRASE__ EmailPasswordAuth __END_HIGHLIGHT_PHRASE__} from "supertokens-auth-react/recipe/emailpassword";
import Session from "supertokens-auth-react/recipe/session";
...
import React from 'react';
import SuperTokens from "supertokens-auth-react";
import {__HIGHLIGHT_PHRASE__ EmailPasswordAuth __END_HIGHLIGHT_PHRASE__} from "supertokens-auth-react/recipe/emailpassword";
...
An example of this can be found in [our demo app](https://github.com/supertokens/supertokens-demo-react/blob/master/src/Home/CallAPIView.js#L4).
