...
- If not, you can always ask for help via [Github issues](https://github.com/supertokens/supertokens-core/issues) or via [our Discord](https://supertokens.com/discord). You should even checkout the Troubleshooting section on the left navigation section.
