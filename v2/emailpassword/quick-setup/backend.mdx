...
:::tip security
Please carefully set your CORS rules. It is **very important to explicitly set a list of allowed origins**. When adding origins make sure to add the full website URL, for example, if the domain is `example.com` make sure the value set is `https://example.com`.
:::
