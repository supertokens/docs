...
Go to the [open source download page](https://supertokens.com/use-oss), click on the "Binary" tab, choose your database, and download the SuperTokens zip file for your OS. Once downloaded, extract the zip and run the install commands.
