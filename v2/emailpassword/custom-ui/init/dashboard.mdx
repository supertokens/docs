...
Inorder to get started with the user roles and permissions on the dashboard you need to first initialise the UserRoles recipe in the `recipeList`.
...
Once the successfull creation of a role you can see it in the roles list.
...
You can also edit (remove or add new permissions) a roles permissions by clicking on the edit button after the creation of the role although it's worth keeping in mind that you cannot change the roles name.
