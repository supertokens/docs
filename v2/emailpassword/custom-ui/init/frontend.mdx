...
- Use the frontend SDK's helper functions to build your own UI - follow along the docs in the "Social / SSO Login" section and you will find various flows and implementations. TODO - link to the page
