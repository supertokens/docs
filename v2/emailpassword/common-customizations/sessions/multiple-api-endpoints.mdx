...
To enable use of sessions for multiple API endpoints, you need to use the `sessionTokenBackendDomain` config on the frontend and backend `Session.init` function call.
