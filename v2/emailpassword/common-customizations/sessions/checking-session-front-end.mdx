...
function Dashboard(props: any) {
      ...
      if (session.loading) {
            ...
            // This may also mean that you are in an SSR environment
            // This will never occur if requireAuth is not set to false in the ^{recipeNameCapitalLetters}Auth component
            return null;
      }
