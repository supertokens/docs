...
from supertokens_python.recipe.emailpassword.interfaces import APIInterface, APIOptions, SignInPostOkResponse
...
def override_email_password_apis(original_implementation: APIInterface):
    ...
    async def sign_in_post(form_fields: List[FormField], api_options: APIOptions, user_context: Dict[str, Any]):
        ...
        if isinstance(response, SignInPostOkResponse):
