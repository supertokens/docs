...
Recipes functions/APIs don't check for this flag, and, all the statically configured recipes will function as defined, even if the user has disabled them in the core.
...
The recipe functions/APIs check if the recipe is enabled in the core and then continue it's execution
