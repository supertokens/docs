...
*Note: The user can still explicitly initialize the recipe in case the recipe functions needs overriding.*
...
*Note: The user will need to explicitly initialize the recipe in case of a multi-tenant setup, to be able to provide the tenantId*
...
<ArgumentPro> Frontend: No additional config for the user, in case of single tenant / dynamic config </ArgumentPro>
