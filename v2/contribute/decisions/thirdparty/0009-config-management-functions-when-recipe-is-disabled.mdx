...
<ArgumentCon> User will be forced to enable a recipe before adding it's configs </ArgumentCon>

### Should be allowed

<ArgumentPro> Better user experience as he can add/update all the configs and then enable the recipe </ArgumentPro>
