...
- By default, access tokens will be signed using dynamic keys. This can be changed through a setting in the BE SDK. (this replaces the core config option)
- By default, jwts will be signed using the static key. This can be controlled through a parameter passed to the `createJWT` function.
