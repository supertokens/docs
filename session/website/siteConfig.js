...
const siteConfig = {
  ...
  baseUrl: "/docs/session/", // when creating new documentation, replace session with folder name
  ...
  */
  ...
  // NOTE: when adding a new documentation, change session with the folder name
  scripts: [
    "https://buttons.github.io/buttons.js",
    'https://cdnjs.cloudflare.com/ajax/libs/clipboard.js/2.0.0/clipboard.min.js',
    "/docs/session/scripts/builder.js",
  ],
