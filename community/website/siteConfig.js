...
const siteConfig = {
  title: "SuperTokens Community", // Title for your website.
  tagline: "Session management",
  url: "https://supertokens.com", // Your website URL
  baseUrl: "/docs/community/", // when creating new documentation, replace initialDocs with folder name
  // Used for publishing and more, irrelevant for us
  projectName: "test-site",
  organizationName: "facebook",
  // For no header links in the top nav bar -> headerLinks: [],
  headerLinks: [
    { doc: "getting-started/installation", label: "Docs" }, // main is the id for the default document
  ...
  */
  ...
  scripts: [
    ...
    "/docs/community/scripts/builder.js",
  ],
