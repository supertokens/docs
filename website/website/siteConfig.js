...
const siteConfig = {
  title: "SuperTokens Website", // Title for your website.
  tagline: "A website for testing",
  url: "https://supertokens.io", // Your website URL
  baseUrl: "/docs/website/", // when creating new documentation, replace initialDocs with folder name
  ...
  */
  ...
  scripts: [
    ...
    "/docs/website/scripts/builder.js",
  ],
