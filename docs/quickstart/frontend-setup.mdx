...
<FrontendPrebuiltUITabs showMobileTab>
  <FrontendPrebuiltUITabs.TabItem value="reactjs">
    ...
    The `init` call includes the [main configuration details](/docs/references/frontend-sdks/reference#sdk-configuration), as well as the **recipes** that you will be using in your setup.
...
The invocation includes the [main configuration details](/docs/references/frontend-sdks/reference#sdk-configuration), as well as the **recipes** that you will be using in your setup.
