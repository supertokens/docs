...
To do this you can follow the [app router](/quickstart/integrations/nextjs/app-directory/about) or [pages router](/quickstart/integrations/nextjs/app-directory/about) instructions.
...
![Supabase dashboard](/docs/img/thirdpartyemailpassword/supabase/supabase_dashboard_create.png)
...
![Supabase table create](/docs/img/thirdpartyemailpassword/supabase/supabase_table_create.png)
...
Follow either the [app router](/quickstart/integrations/nextjs/app-directory/about) or [pages router](/quickstart/integrations/nextjs/app-directory/about) guides for instructions on how to configure your application.
...
- Select `Authentication` from the Supabase sidebar menu, click `Policies`, and then `New Policy` on the `Users` table.
    ...
    ![Create policy](/docs/img/thirdpartyemailpassword/supabase/create_policy.png)

- From the modal, select `Create a policy from scratch` and add the following.

    ![select policy](/docs/img/thirdpartyemailpassword/supabase/policy_config_select.png)
...
- Create another policy and add the following:
    ...
    ![insert policy](/docs/img/thirdpartyemailpassword/supabase/policy_config_insert.png)
...
![auth screen](/docs/img/thirdpartyemailpassword/supabase/supabase_app_authenticated_screen.png)

If you navigate to your table you should see a new row with the user's `user_id` and `email`.

![table with user](/docs/img/thirdpartyemailpassword/supabase/table_with_user.png)
