---
title: Backend Setup
description: Set up SuperTokens authentication for your backend using Node.js, Python, or Go SDKs.
sidebar:
  order: 3
---
...
:::info[At the moment we only have SDKs for **Node.js**, **Python** and **Go**.]
If you wish to use **SuperTokens** with other languages you will have to create a separate authentication service.
Please check [our guide](/references/backend-sdks/other-frameworks) that shows you how to resolve this.
