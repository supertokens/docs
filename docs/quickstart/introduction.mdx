---
title: Introduction
description: Set up user authentication with SuperTokens using Email/Password login and customizable UI components.
sidebar:
  order: 1
---
...
<Tabs>
  <Tab title="Managed service">
    <img
      src="/docs/img/architecture/managed_service_without_dashboard.png"
      alt="Flowchart of architecture when using SuperTokens managed service"
    />
  </Tab>
  <Tab title="Self-hosted">
    <img
      src="/docs/img/architecture/self_hosted_without_dashboard.png"
