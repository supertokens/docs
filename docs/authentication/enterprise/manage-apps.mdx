...
```python {6} check=false reason="This example omits surrounding application and SuperTokens configuration."
...
```json check=false reason="The nested tenant fields are abbreviated for readability."
{
    "status": "OK",
    "apps": [{
        "appId": "app1",
...
:::note[Before you delete an app, ensure that you satisfy the following requirements:]
...
:::danger[This operation cannot be undone. Make sure you have backed up any important data before proceeding.]
:::
