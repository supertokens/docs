...
<img alt="Flowchart of integrating a `SAML` provider with SuperTokens using `SAML` Jackson ( BoxyHQ )" src="/docs/img/saml/supertokens-boxyhq.png" />
...
If you have skipped those steps page please go through the main [quickstart guide](/quickstart/introduction).
 
## Using the SuperTokens dashboard

:::warning[This is only available with Node and Python SDKs.]
...
<img src="/docs/img/dashboard/tenant-management/tp-create-tenant.gif" alt="Create Tenant"/>

### 4. Configure the SAML provider for the tenant

<img src="/docs/img/dashboard/tenant-management/new-boxy-config.gif" alt="Create Tenant"/>
