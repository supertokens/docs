...
<img alt="Flowchart of integrating a `SAML` provider with SuperTokens using `SAML` Jackson ( BoxyHQ )" src="/docs-assets/img/saml/supertokens-boxyhq.png" />
...
<img src="/docs-assets/img/dashboard/tenant-management/tp-create-tenant.gif" alt="Create Tenant"/>

### 4. Configure the SAML provider for the tenant

<img src="/docs-assets/img/dashboard/tenant-management/new-boxy-config.gif" alt="Create Tenant"/>
