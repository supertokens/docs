...
![Single tenant single app architecture](/docs-assets/img/single-tenant-single-app.png)
...
![Single tenant multi app architecture](/docs-assets/img/single-tenant-multi-app.png)
...
![Multi tenant single app architecture](/docs-assets/img/multi-tenant-single-app.png)
...
![Multi tenant multi app architecture](/docs-assets/img/multi-tenant-multi-app.png)
