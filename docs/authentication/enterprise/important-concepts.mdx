...
![Single tenant single app architecture](/docs/img/single-tenant-single-app.png)
...
![Single tenant multi app architecture](/docs/img/single-tenant-multi-app.png)
...
![Multi tenant single app architecture](/docs/img/multi-tenant-single-app.png)
...
![Multi tenant multi app architecture](/docs/img/multi-tenant-multi-app.png)
