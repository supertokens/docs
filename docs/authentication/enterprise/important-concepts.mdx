...
![Single tenant single app architecture](/img/single-tenant-single-app.png)
...
![Single tenant multi app architecture](/img/single-tenant-multi-app.png)
...
![Multi tenant single app architecture](/img/multi-tenant-single-app.png)
...
![Multi tenant multi app architecture](/img/multi-tenant-multi-app.png)
