...
<img src="/docs/img/dashboard/tenant-management/create-tenant.png" alt="Create Tenant"/>

Create a new tenant by clicking on the **Add Tenant** button and specify the tenant ID.

<img src="/docs/img/dashboard/tenant-management/all-enabled.png" alt="All Login Methods Enabled"/>
...
<img src="/docs/img/dashboard/tenant-management/custom-tenant-config.png" alt="Custom tenant configuration"/>
