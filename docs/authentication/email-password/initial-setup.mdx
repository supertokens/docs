...
description: Add email and password authentication to your frontend and backend, then prepare the integration for production.
sidebar:
  label: Initial Setup
  order: 15
---
...
Now that you have completed the initial setup, continue configuring SuperTokens for your application's authentication and authorization requirements.
