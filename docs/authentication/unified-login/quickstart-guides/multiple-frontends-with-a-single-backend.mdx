...
<img src="/docs/img/oauth/multiple-frontend-domains-with-a-single-backend.png" alt="Multiple Frontend Domains with a Single Backend"/>
...
const JWKS = jose.createRemoteJWKSet(
  new URL("<YOUR_API_DOMAIN>/auth/jwt/jwks.json"),
);
