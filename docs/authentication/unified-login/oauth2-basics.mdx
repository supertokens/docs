...
<img src="/docs-assets/img/oauth/authorization-code-flow.png" alt="Authorization Code Grant"/>
...
<img src="/docs-assets/img/oauth/client-credentials-flow.png" alt="Client Credentials Grant"/>
