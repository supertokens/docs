...
:::info[SDK Support]
WebAuthn (Passkeys) authentication is available in the **Node.js SDK**, **Python SDK**, and **Go SDK**.
:::

:::warning[WebAuthn deployment requirements]
...
instead of relying on values derived from the API domain.
:::
