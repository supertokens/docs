...
| `emailDelivery` | Configures how the system builds and sends verification emails to users. Read the [email delivery page](/platform-configuration/email-delivery) for more information. | Default email service |
...
| `email_delivery` | Configures how the system builds and sends verification emails to users. Read the [email delivery page](/platform-configuration/email-delivery) for more information. | Default email service |
