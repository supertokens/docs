...
<Steps>
<Step title="The frontend SDK requests registration options from the backend.">
The options are then returned based on the response from the **SuperTokens** core service.
</Step>
<Step title="The authenticator uses the response to sign a challenge with your passkey.">

</Step>
<Step title="The result of the authenticator operation gets validated by the SuperTokens core service.">
...
![Sign in form UI for passkeys login](/docs/img/webauthn-signin.png)

### Sign up

<Steps>
<Step title="The user enters their email address in frontend authentication UI ">
...
<Step title="The result of the authenticator operation gets validated on by the SuperTokens core service.">
...
![Passkeys sign up flow](/docs/img/webauthn-signup.png)
...
![Sign in form UI for passkeys login](/docs/img/webauthn-recover-account.png)
