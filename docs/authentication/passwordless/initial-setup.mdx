---
title: Passwordless Setup for Magic Link Login and OTPs
description: Set up magic link login with the SuperTokens Passwordless recipe, or use email and SMS OTPs with prebuilt or custom UI.
sidebar:
  label: Initial Setup
  order: 20
---
...
## Magic link login and passwordless setup
