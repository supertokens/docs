...
For custom UI implementations, use the [`consumeCode` function provided by the frontend SDK](/authentication/passwordless/initial-setup) to call the `passwordless` API that verifies the code in the URL and creates the user.
