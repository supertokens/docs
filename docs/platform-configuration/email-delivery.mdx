...
- Email delivery applies to the EmailPassword, Passwordless, and AccountLinking recipes.
- Without configuration, the backend SDK sends through `https://api.supertokens.com` from `noreply@supertokens.io`; this default service does not support template customization.
