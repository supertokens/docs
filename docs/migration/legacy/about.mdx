...
If you are using MFA in your app, checkout the MFA migration section [here](/additional-verification/mfa/migration/legacy-to-new) after you have gone through the above migration steps.
...
<CardGroup cols={3}>
  <Card title="Migration overview" href="/migration/overview" />
  ...
  <Card title="MFA migration" href="/additional-verification/mfa/migration/legacy-to-new" />
  <Card title="User data migration" href="/migration/legacy/data-migration" />
</CardGroup>
