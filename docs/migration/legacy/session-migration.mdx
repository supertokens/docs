...
<img src="/docs-assets/img/migration/session-migration-diagram.png" alt="Session migration flow chart" />
...
<CardGroup cols={3}>
  ...
  <Card title="User creation" href="/migration/legacy/account-creation/user-creation" />
  <Card title="Data migration" href="/migration/legacy/data-migration" />
