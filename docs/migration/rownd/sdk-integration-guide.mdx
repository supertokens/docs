...
Install the base SuperTokens Python SDK together with the Rownd migration plugin. Until the Rownd package is published to PyPI, install it from the `rownd-python` branch.
...
```bash
pip install supertokens-python "supertokens-rownd @ git+https://github.com/supertokens/supertokens-plugins.git@rownd-python#subdirectory=packages/rownd-python"
```
...
```bash
uv add supertokens-python "supertokens-rownd @ git+https://github.com/supertokens/supertokens-plugins.git@rownd-python#subdirectory=packages/rownd-python"
```
