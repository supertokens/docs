...
For detailed instructions on how to integrate SDKs you can read [the full guide](/docs/migration/rownd/sdk-integration-guide).
...
The [SDK integration guide](/docs/migration/rownd/sdk-integration-guide) goes into detail on how to do this.
...
Continue with the [SDK Integration Guide](/docs/migration/rownd/sdk-integration-guide). The backend plugin must be deployed before clients can migrate sessions or use SuperTokens-backed Rownd flows.
