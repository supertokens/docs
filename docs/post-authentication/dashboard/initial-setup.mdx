...
<img class="docs-image-content-width" src="/docs-assets/img/architecture/managed_service_generic.png" alt="Flowchart of architecture when using SuperTokens managed service" />
</Tab>
<Tab title="Self-hosted">
<img class="docs-image-content-width" src="/docs-assets/img/architecture/self_hosted_generic.png" alt="Flowchart of architecture when self-hosting SuperTokens" />
</Tab>
</Tabs>
...
![Content Security Policy error handled UI](/docs-assets/img/dashboard/csp-error.png)
...
<img src="/docs-assets/img/dashboard/login.png" alt="Dashboard login screen UI" />
...
<img src="/docs-assets/img/dashboard/signup.png" alt="Dashboard sign up screen UI" />
...
<img src="/docs-assets/img/dashboard/forgot-password.png" alt="Reset your password screen UI" />
