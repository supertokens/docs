...
```tsx {13} check=false reason="Requires surrounding framework application context"
...
```python {9} check=false reason="Requires surrounding framework application context"
...
```python {12} check=false reason="Requires surrounding framework application context"
from flask import g
...
```python {13} check=false reason="Requires surrounding application context"
