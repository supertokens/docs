...
<img alt="Checking which component from the prebuilt UI is overridden using React Developer Tools extension" src="/docs/img/thirdpartyemailpassword/override/find-component.png" />
...
<img alt="Prebuilt sign in UI with custom image" src="/docs/img/thirdpartyemailpassword/react-override-octocat.png" />
