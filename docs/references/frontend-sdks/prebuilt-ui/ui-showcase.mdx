...
<img src="/docs/img/emailpassword-sign-in.png" alt="Sign in form UI for email password login" />
</AccordionItem>
<AccordionItem title="Default sign up form">
<img src="/docs/img/emailpassword-sign-up.png" alt="Sign up form UI for email password login" />
</AccordionItem>
...
<img src="/docs/img/emailpassword-field-validation-error.png" alt="Sign up form field error UI" />
</AccordionItem>
...
<img src="/docs/img/emailpassword-wrong-cred.png" alt="Sign in form wrong credentials UI" />
</AccordionItem>
...
<img src="/docs/img/emailpassword-general-error.png" alt="Sign in form general error" />
</AccordionItem>
</Accordion>
...
<img src="/docs/img/email-verification-send-email.png" alt="Email verification email sent" />
...
<img src="/docs/img/email-verification-success.png" alt="Email verification success" />
...
<img src="/docs/img/email-verification-clicked-no-session.png" alt="Email verification no session prompt" />
...
<img src="/docs/img/email-verification-link-expired.png" alt="Email verification no session prompt" />
...
<img src="/docs/img/email-verification-send-email-generic-error.png" alt="Email verification generic error" />
...
<img src="/docs/img/email-verification-link-generic-error.png" alt="Email verification link clicked generic error" />
</AccordionItem>
...
<img alt="Email UI for email verification email" width="450px" src="/docs/img/emailpassword/email-verify-email.png" />
</AccordionItem>
</Accordion>
...
<img src="/docs/img/reset-password-email.png" alt="Enter email in reset password form" />
...
<img src="/docs/img/reset-password-email-sent.png" alt="Email sent in reset password form" />
</AccordionItem>
...
<img src="/docs/img/reset-password-new-password.png" alt="Enter new password form" />

If the reset token has expired or is invalid, the user sees the following message.

<img src="/docs/img/reset-password-new-password-invalid-token.png" alt="Enter new password for invalid token" />

Once the user has successfully changed their password, they see the following success screen

<img src="/docs/img/password-reset-success.png" alt="Password change successful" />
...
<img src="/docs/img/password-reset-general-error.png" alt="Enter email general error" />

<img src="/docs/img/new-password-general-error.png" alt="Enter new password general error" />
</AccordionItem>
...
<img src="/docs/img/passwordless-email-phone.png" alt="Email and phone passwordless login" />
...
<img src="/docs/img/passwordless-email.png" alt="Email only passwordless login" />
</AccordionItem>
...
<img src="/docs/img/passwordless-phone.png" alt="Phone only passwordless login" />
</AccordionItem>
...
<img src="/docs/img/passwordless-invalid-phone-email.png" alt="Invalid phone or email" />
</AccordionItem>
...
<img src="/docs/img/magic-link-sent.png" alt="Magic link sent UI" />
...
<img src="/docs/img/magic-link-clicked.png" alt="Magic link consumed" />
...
<img src="/docs/img/magic-link-clicked-different-device.png" alt="Magic link consumed on different device" />
...
<img src="/docs/img/passwordless-magic-link-expired.png" alt="Invalid magic link" />
</AccordionItem>
...
<img src="/docs/img/enter-otp-screen.png" alt="Enter OTP screen" />
...
<img src="/docs/img/enter-otp-invalid.png" alt="Invalid OTP" />
...
<img src="/docs/img/passwordless-too-many-otp-tries.png" alt="Entered invalid OTP too many times" />
...
<img src="/docs/img/passwordless-passwordless-general-error.png" alt="Login screen general error" />

<img src="/docs/img/enter-otp-error.png" alt="Enter OTP screen general error" />

<img src="/docs/img/magic-link-sent-error.png" alt="Magic link sent screen general error" />
...
<img src="/docs/img/thirdparty-sign-in-custom-provider.png" alt="Sign in form UI for social login" />
</AccordionItem>
...
<img src="/docs/img/thirdparty-thirdparty-callback.png" alt="Callback screen from third party provider." />
</AccordionItem>
...
<img src="/docs/img/thirdparty-no-email.png" alt="No email UI for provider" />
</AccordionItem>
<AccordionItem title="General error UI">
If there are network related errors, or the backend sends a status code >= 300, then the following UI shows. This UI also appears if there is a similar error in the callback page.

<img src="/docs/img/thirdparty-general-error.png" alt="Sign in form general error" />
</AccordionItem>
</Accordion>
