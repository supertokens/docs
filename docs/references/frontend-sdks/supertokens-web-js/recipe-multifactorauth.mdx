...
[`SessionClaim`](recipe-session#sessionclaim).[`getLastFetchedTime`](recipe-session#getlastfetchedtime-6)
...
[`SessionClaim`](recipe-session#sessionclaim).[`getValueFromPayload`](recipe-session#getvaluefrompayload-6)
...
[`SessionClaim`](recipe-session#sessionclaim).[`refresh`](recipe-session#refresh-5)
