...
| Parameter | Type |
| ------ | ------ |
| `input?` | \| \{ `options?`: `RecipeFunctionOptions`; `userContext?`: [`UserContext`](types#usercontext-1); `userInputCode`: `string`; \} \| \{ `options?`: `RecipeFunctionOptions`; `userContext?`: [`UserContext`](types#usercontext-1); \} |
...
| Parameter | Type |
| ------ | ------ |
| `input` | \| \{ `email`: `string`; `options?`: `RecipeFunctionOptions`; `shouldTryLinkingWithSessionUser?`: `boolean`; `userContext?`: [`UserContext`](types#usercontext-1); \} \| \{ `options?`: `RecipeFunctionOptions`; `phoneNumber`: `string`; `shouldTryLinkingWithSessionUser?`: `boolean`; `userContext?`: [`UserContext`](types#usercontext-1); \} |
...
| Parameter | Type |
| ------ | ------ |
| `input` | \{ `email`: `string`; `options?`: `RecipeFunctionOptions`; `userContext?`: [`UserContext`](types#usercontext-1); \} |
| `input.email` | `string` |
...
| Parameter | Type |
| ------ | ------ |
| `input` | \{ `options?`: `RecipeFunctionOptions`; `phoneNumber`: `string`; `userContext?`: [`UserContext`](types#usercontext-1); \} |
| `input.options?` | `RecipeFunctionOptions` |
...
| Parameter | Type |
| ------ | ------ |
| `input` | \{ `attemptInfo`: `object` & `CustomStateProperties`; `userContext?`: [`UserContext`](types#usercontext-1); \} |
