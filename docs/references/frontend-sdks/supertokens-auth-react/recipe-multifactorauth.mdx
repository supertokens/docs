...
| Parameter | Type |
| ------ | ------ |
| `input` | \{ `factorId`: `string`; `forceSetup?`: `boolean`; `navigate?`: [`Navigate`](types#navigate-1); `redirectBack?`: `boolean`; `stepUp?`: `boolean`; `userContext?`: [`UserContext`](types#usercontext-1); \} |
| `input.factorId` | `string` |
| `input.forceSetup?` | `boolean` |
| `input.navigate?` | [`Navigate`](types#navigate-1) |
...
| Parameter | Type |
| ------ | ------ |
| `input` | \{ `navigate?`: [`Navigate`](types#navigate-1); `nextFactorOptions?`: `string`[]; `redirectBack?`: `boolean`; `stepUp?`: `boolean`; `userContext?`: [`UserContext`](types#usercontext-1); \} |
| `input.navigate?` | [`Navigate`](types#navigate-1) |
