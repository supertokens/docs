...
| ------ | ------ |
| `axiosInstance` | `any` |
| `userContext?` | [`UserContext`](types#usercontext-1) |
...
| Parameter | Type |
| ------ | ------ |
| `input` | \{ `claim`: `SessionClaim`\<`T`\>; `userContext?`: [`UserContext`](types#usercontext-1); \} |
...
| Parameter | Type |
| ------ | ------ |
| `input` | \{ `response`: \| `Response` \| \{ `data`: `any`; \}; `userContext`: [`UserContext`](types#usercontext-1); \} |
...
| Parameter | Type |
| ------ | ------ |
| `input?` | \{ `overrideGlobalClaimValidators?`: (`globalClaimValidators`, `userContext`) => `SessionClaimValidator`[]; `userContext?`: [`UserContext`](types#usercontext-1); \} |
