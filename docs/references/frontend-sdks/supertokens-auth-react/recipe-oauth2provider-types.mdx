...
| <a id="usercontext"></a> `userContext` | [`UserContext`](types#usercontext-1) | [recipe/oauth2provider/types.ts:25](https://github.com/supertokens/supertokens-auth-react/blob/b337b23722adfbe2906b193ea5fcf98f9c98c8b0/lib/ts/recipe/oauth2provider/types.ts#L25) |
