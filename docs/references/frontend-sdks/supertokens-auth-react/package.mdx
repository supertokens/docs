...
| Parameter | Type |
| ------ | ------ |
| `options?` | \{ `navigate?`: [`Navigate`](types#navigate-1); `queryParams?`: `any`; `redirectBack?`: `boolean`; `show?`: `"signin"` \| `"signup"`; `userContext?`: [`UserContext`](types#usercontext-1); \} |
| `options.navigate?` | [`Navigate`](types#navigate-1) |
| `options.queryParams?` | `any` |
| `options.redirectBack?` | `boolean` |
| `options.show?` | `"signin"` \| `"signup"` |
| `options.userContext?` | [`UserContext`](types#usercontext-1) |
