...
<CardGroup cols={3}>
  <Card title="ReactJS" href="https://supertokens.com/docs/auth-react" icon="/img/icons/react.svg">

</Card>

  <Card title="Vanilla JS" href="https://supertokens.com/docs/web-js" icon="/img/icons/js.svg">

</Card>

  <Card title="React Native" href="https://supertokens.com/docs/react-native" icon="/img/icons/react.svg">

</Card>

  <Card title="iOS" href="https://supertokens.com/docs/ios" icon="/img/icons/ios.svg">

</Card>

  <Card title="Android" href="https://supertokens.com/docs/android" icon="/img/icons/android.svg">

</Card>

  <Card title="Flutter" href="https://supertokens.com/docs/flutter" icon="/img/icons/flutter.svg">
