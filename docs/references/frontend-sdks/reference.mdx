...
<CardGroup cols={3}>
  <Card title="Function overrides" href="/references/frontend-sdks/function-overrides" icon="code" />
  <Card title="Hooks" href="/references/frontend-sdks/hooks" icon="webhook" />
  <Card title="Component override" href="/references/frontend-sdks/prebuilt-ui/override-react-components" icon="component" />
  <Card title="Prebuilt UI styling" href="/references/frontend-sdks/prebuilt-ui/changing-style" icon="paintbrush" />
  <Card title="Prebuilt UI theming" href="/references/frontend-sdks/prebuilt-ui/changing-colours" icon="palette" />
  <Card title="Translations" href="/references/frontend-sdks/prebuilt-ui/translations" icon="languages" />
</CardGroup>
...
<Columns cols={2}>
  <Column>
    <h3><PresentedOption label="React" value="reactjs" /></h3>
    <GithubInfo owner="supertokens" repo="supertokens-auth-react" />
  </Column>
  <Column>
    <h3><PresentedOption label="JavaScript" value="javascript" /></h3>
    <GithubInfo owner="supertokens" repo="supertokens-web-js" />
  </Column>
  <Column>
    <h3><PresentedOption label="iOS" value="ios" /></h3>
    <GithubInfo owner="supertokens" repo="supertokens-ios" />
  </Column>
  <Column>
    <h3><PresentedOption label="React Native" value="reactnative" /></h3>
    <GithubInfo owner="supertokens" repo="supertokens-react-native" />
  </Column>
  <Column>
    <h3><PresentedOption label="Android" value="android" /></h3>
    <GithubInfo owner="supertokens" repo="supertokens-android" />
  </Column>
</Columns>
