---
title: put Create or update connection URI domain (deprecated)
sidebar_position: 1
description: >-
...
<APIRequestPage apiName="cdi" method="put" path="/recipe/multitenancy/connectionuridomain" title="/recipe/multitenancy/connectionuridomain" />
