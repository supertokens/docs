...
This is the API exposed by the **SuperTokens Core** service.
It is meant to be consumed only by your backend only.

:::info no-title
In most cases you will not need to use this API directly.
The [backend SDKs](/docs/references/backend-sdks/reference) expose methods that you can call directly from your code.
:::
...
If you want to check an older release, please access the [swaggerhub page](https://app.swaggerhub.com/apis/supertokens/CDI)
