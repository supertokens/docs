...
<img alt="Request to change user data in postman" width="600px" src="/docs/img/st-thirdparty-change-user.png" />
...
<img alt="Failed query due to expired access token in postman" width="600px" src="/docs/img/emailpassword/st-user-unauthorized.png" />
...
<img alt="Successful session refresh in postman" width="600px" src="/docs/img/emailpassword/st-ep-refresh.png" />

You can see the new session tokens by switching to the cookies tab

<img alt="Viewing session tokens in cookies tab in postman" width="600px" src="/docs/img/emailpassword/st-ep-refresh-cookies.png" />
...
<img alt="Successful sign out request in postman" width="600px" src="/docs/img/emailpassword/st-ep-signout.png" />
