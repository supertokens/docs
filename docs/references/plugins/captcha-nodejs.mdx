...
Defined in: [supertokens-plugins/packages/captcha-nodejs/src/errors.ts:5](https://github.com/supertokens/supertokens-plugins/blob/main/packages/captcha-nodejs/src/errors.ts#L5)
...
Defined in: [supertokens-plugins/packages/captcha-nodejs/src/errors.ts:6](https://github.com/supertokens/supertokens-plugins/blob/main/packages/captcha-nodejs/src/errors.ts#L6)
...
| <a id="type"></a> `type` | `"reCAPTCHAv3"` \| `"reCAPTCHAv2"` \| `"turnstile"` | - | [supertokens-plugins/packages/captcha-nodejs/src/types.ts:36](https://github.com/supertokens/supertokens-plugins/blob/main/packages/captcha-nodejs/src/types.ts#L36) |
