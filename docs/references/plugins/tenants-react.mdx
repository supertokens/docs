---
title: '@supertokens-plugins/tentants-react'
---
...
| Name | Type | Defined in |
| ------ | ------ | ------ |
| <a id="member-default-init"></a> `init` | `any` | [supertokens-plugins/packages/tenants-react/src/index.ts:5](https://github.com/supertokens/supertokens-plugins/blob/main/packages/tenants-react/src/index.ts#L5) |
