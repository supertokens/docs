...
| <a id="member-implementation-getsections"></a> `getSections` | `public` | (`this`: [`Implementation`](#implementation), `session`: `SessionContainerInterface`, `userContext?`: [`Record`](https://www.typescriptlang.org/docs/handbook/utility-types.html#recordkeys-type)\<`string`, `any`\>) => `BaseFormSection`[] | `undefined` | [supertokens-plugins/packages/profile-details-nodejs/src/implementation.ts:185](https://github.com/supertokens/supertokens-plugins/blob/main/packages/profile-details-nodejs/src/implementation.ts#L185) |
...
| ------ | ------ | ------ |
| <a id="member-supertokenspluginprofiledetailsimplementation-thirdpartyfieldmap"></a> `thirdPartyFieldMap` | (`originalImplementation`: [`ThirdPartyFieldMap`](#thirdpartyfieldmap)) => [`ThirdPartyFieldMap`](#thirdpartyfieldmap) | [supertokens-plugins/packages/profile-details-nodejs/src/types.ts:11](https://github.com/supertokens/supertokens-plugins/blob/main/packages/profile-details-nodejs/src/types.ts#L11) |
