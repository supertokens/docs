...
<CardGroup cols={3}>
  <Card title="NodeJS" href="/references/backend-sdks/supertokens-nodejs/package" icon="/img/icons/node.svg">

</Card>

  <Card title="GoLang" href="/references/backend-sdks/other-frameworks" icon="/img/icons/go.svg">

</Card>

  <Card title="Python" href="/references/backend-sdks/other-frameworks" icon="/img/icons/python.svg">
