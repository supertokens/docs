...
<CardGroup cols={3}>
  <Card title="Function overrides" href="https://supertokens.com/docs/auth-react">

</Card>
  <Card title="API overrides" href="https://supertokens.com/docs/auth-react">

</Card>

  <Card title="Hooks" href="https://supertokens.com/docs/auth-react">
...
<CardGroup cols={3}>
  <Card title="NodeJS" href="https://supertokens.com/docs/nodejs" icon="/img/icons/node.svg">

</Card>

  <Card title="GoLang" href="https://supertokens.com/docs/golang" icon="/img/icons/go.svg">

</Card>

  <Card title="Python" href="https://supertokens.com/docs/python" icon="/img/icons/python.svg">
