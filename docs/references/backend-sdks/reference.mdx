---
title: Reference
description: Find SuperTokens backend SDK references and customize authentication functions, APIs, and configuration.
sidebar:
  icon: book-open
  order: 10
---
...
<CardGroup cols={3}>
  <Card title="Function overrides" href="/references/backend-sdks/function-overrides" icon="code" />
  <Card title="API overrides" href="/references/backend-sdks/api-overrides" icon="server" />
  <Card title="Hooks" href="/references/backend-sdks/function-overrides" icon="webhook" />
</CardGroup>
...
<Columns cols={2}>
  <Column>
    <h3><PresentedOption label="Node.js" value="nodejs" /></h3>
    <GithubInfo owner="supertokens" repo="supertokens-node" />
  </Column>
  <Column>
    <h3><PresentedOption label="Go" value="go" /></h3>
    <GithubInfo owner="supertokens" repo="supertokens-golang" />
  </Column>
  <Column>
    <h3><PresentedOption label="Python" value="python" /></h3>
    <GithubInfo owner="supertokens" repo="supertokens-python" />
  </Column>
</Columns>
...
```ts check=false reason="configuration type excerpt references the SDK UserContext type"
let appInfo: {
  appName: string;
  apiDomain: string;
