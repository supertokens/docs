...
description: Set up an authentication server with SuperTokens for unsupported backend frameworks.
sidebar:
  order: 80
---
...
<img
  ...
  src="/docs-assets/img/other-framework-setup.png"
  alt="SuperTokens setup with an authentication server"
/>
