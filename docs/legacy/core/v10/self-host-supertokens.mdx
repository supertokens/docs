...
import { SelfHostingTabs, DatabaseTabs, BackendTabs } from "/src/components/Tabs";
...
```bash
docker run -p 3567:3567 -d registry.supertokens.io/supertokens/supertokens-mysql@10.1
```
