---
title: Scalability
description: Learn how SuperTokens scales to handle millions of users and requests efficiently.
sidebar:
  order: 4
---
...
:::note[If you are using the managed service, the SuperTokens core is fully managed, and you don't have to worry about scaling it.]
...
<img src="/docs-assets/img/avg-latency.png" />

### Number of requests per minute over 1 day

<img src="/docs-assets/img/rpm.png" />
