...
For a broader overview of the Core's security model and the behaviors that are intentional by design, see [Security model](/docs/platform-configuration/supertokens-core/security).
