...
Check the [quickstart guide](/additional-verification/attack-protection-suite/initial-setup) for instructions on how to set it up.
:::
...
<Frame>
  <img src="/docs-assets/img/attackprotectionsuite/sequence-diagram.png" alt="Attack Protection Suite flow" />
</Frame>
