...
The first part is identical to the steps mentioned in [this section](/additional-verification/mfa/totp/totp-for-all-users#2-configure-the-), so please follow that.
