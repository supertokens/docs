...
<DependentContent group="yes-no-si6mlc-1" label="Choice">
...
:::note[Notice that in Case 2, there is no UI for the user to enter an email. That happens. The user only sees the enter OTP screen.]
:::
...
<DependentContent group="yes-no-si6mlc-2" label="Choice">
<ContentOption title="Yes" value="yes">
