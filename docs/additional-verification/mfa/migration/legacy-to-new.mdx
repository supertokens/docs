...
description: Migrate from legacy to new MFA method, integrating backend and frontend changes for enhanced security.
sidebar:
  order: 2
  hidden: true
---

This page only applies if you have used our [legacy MFA method](/additional-verification/mfa/legacy-mfa/how-it-works) and want to migrate to the new MFA method.
