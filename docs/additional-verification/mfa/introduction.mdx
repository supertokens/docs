...
<CardGroup cols={3}>
  <Card title="Important Concepts" href="/additional-verification/mfa/important-concepts">
Go through a quick explanation of how MFA works and some common terminologies.
</Card>
  <Card title="Quickstart Guide" href="/additional-verification/mfa/initial-setup">
Implement an authentication flow that uses MFA.
</Card>
  <Card title="Implement Step Up Authentication" href="/additional-verification/mfa/step-up-auth">
Require additional authentication challenges on specific routes or actions.
</Card>
  <Card title="Implement Recovery Codes" href="/additional-verification/mfa/backup-codes">
...
<CardGroup cols={3}>
  <Card title="Require TOTP for all users" href="/additional-verification/mfa/totp/totp-for-all-users">
Force all users to use TOTP.
</Card>
  <Card title="Require TOTP for specific users" href="/additional-verification/mfa/totp/totp-for-opt-in-users">
Enable TOTP only for some of the users.
</Card>
  <Card title="Require OTP for all users" href="/additional-verification/mfa/email-sms-otp/otp-for-all-users">
Force all users to use OTP.
</Card>
  <Card title="Require OTP for specific users" href="/additional-verification/mfa/email-sms-otp/otp-for-opt-in-users">
Enable OTP only for some of the users.
</Card>
  <Card title="WebAuthn" href="/additional-verification/mfa/webauthn-setup">
Use WebAuthn as a secondary factor
</Card>
  <Card title="Protect frontend and backend routes" href="/additional-verification/mfa/protect-routes">
