...
<ReferenceCard.Grid>
  ...
  <ReferenceCard href="/docs/additional-verification/mfa/webauthn/webauthn-for-all-users">
    <ReferenceCard.Title>
      Require WebAuthn for all users
    </ReferenceCard.Title>
    <ReferenceCard.Description>
      Force all users to use Passkeys.
    </ReferenceCard.Description>
  </ReferenceCard>
  <ReferenceCard href="/docs/additional-verification/mfa/webauthn/webauthn-for-opt-in-users">
    <ReferenceCard.Title>
      Require WebAuthn for specific users
    </ReferenceCard.Title>
    <ReferenceCard.Description>
      Enable Passkeys only for some of the users.
    </ReferenceCard.Description>
  </ReferenceCard>
