...
After following the [frontend quick setup section](/quickstart/introduction) and the [social login guide](/authentication/social/initial-setup), you should have the following `supertokens.init`:
